...
Next:
    ...
    switch (static_cast<OpCode>(*code))
    {
        ...
        case OpCode::LdNull_R0: r0 = {}; code++; goto Next;
        case OpCode::LdNull_R1: r1 = {}; code++; goto Next;
        case OpCode::LdNull_R2: r2 = {}; code++; goto Next;
        case OpCode::LdNull_R3: r3 = {}; code++; goto Next;
        case OpCode::LdNull_R4: r4 = {}; code++; goto Next;
        case OpCode::LdNull_R5: r5 = {}; code++; goto Next;
        case OpCode::LdNull_R6: r6 = {}; code++; goto Next;
        case OpCode::LdNull_R7: r7 = {}; code++; goto Next;
        ...
        case OpCode::Ldc_R0_F4_1:
            r0 = 1.0f; code++; goto Next;
        case OpCode::Ldc_R0_F4_M1:
            r0 = -1.0f; code++; goto Next;
        case OpCode::Ldc_R0_F4_2:
            r0 = 2.0f; code++; goto Next;
        case OpCode::Ldc_R0_F4_05: // 0.5
            r0 = 0.5f; code++; goto Next;
        case OpCode::Ldc_R0_F4_M05: // -0.5
            r0 = -0.5f; code++; goto Next;

        case OpCode::Ldc_R0_X4: // <op> <4 byte value>
            r0 = *reinterpret_cast<const int32_t*>(code + 1); code += 3; goto Next;
        case OpCode::Ldc_R0_X8: // <op> <8 byte value>
            r0 = *reinterpret_cast<const int64_t*>(code + 1); code += 5; goto Next;
        ...
        case OpCode::Ldc_R1_F4_1:
            r1 = 1.0f; code++; goto Next;
        case OpCode::Ldc_R1_F4_M1:
            r1 = -1.0f; code++; goto Next;
        case OpCode::Ldc_R1_F4_2:
            r1 = 2.0f; code++; goto Next;
        case OpCode::Ldc_R1_F4_05: // 0.5
            r1 = 0.5f; code++; goto Next;
        case OpCode::Ldc_R1_F4_M05: // -0.5
            r1 = -0.5f; code++; goto Next;

        case OpCode::Ldc_R1_X4: // <op> <4 byte value>
            r1 = *reinterpret_cast<const int32_t*>(code + 1); code += 3; goto Next;
        case OpCode::Ldc_R1_X8: // <op> <8 byte value>
            r1 = *reinterpret_cast<const int64_t*>(code + 1); code += 5; goto Next;
        ...
        case OpCode::Ldc_R2_F4_1:
            r2 = 1.0f; code++; goto Next;
        case OpCode::Ldc_R2_F4_M1:
            r2 = -1.0f; code++; goto Next;
        case OpCode::Ldc_R2_F4_2:
            r2 = 2.0f; code++; goto Next;
        case OpCode::Ldc_R2_F4_05: // 0.5
            r2 = 0.5f; code++; goto Next;
        case OpCode::Ldc_R2_F4_M05: // -0.5
            r2 = -0.5f; code++; goto Next;

        case OpCode::Ldc_R2_X4: // <op> <4 byte value>
            r2 = *reinterpret_cast<const int32_t*>(code + 1); code += 3; goto Next;
        case OpCode::Ldc_R2_X8: // <op> <8 byte value>
            r2 = *reinterpret_cast<const int64_t*>(code + 1); code += 5; goto Next;
        ...
        case OpCode::Ldc_R3_F4_1:
            r3 = 1.0f; code++; goto Next;
        case OpCode::Ldc_R3_F4_M1:
            r3 = -1.0f; code++; goto Next;
        case OpCode::Ldc_R3_F4_2:
            r3 = 2.0f; code++; goto Next;
        case OpCode::Ldc_R3_F4_05: // 0.5
            r3 = 0.5f; code++; goto Next;
        case OpCode::Ldc_R3_F4_M05: // -0.5
            r3 = -0.5f; code++; goto Next;

        case OpCode::Ldc_R3_X4: // <op> <4 byte value>
            r3 = *reinterpret_cast<const int32_t*>(code + 1); code += 3; goto Next;
        case OpCode::Ldc_R3_X8: // <op> <8 byte value>
            r3 = *reinterpret_cast<const int64_t*>(code + 1); code += 5; goto Next;
        ...
        case OpCode::Ldc_R4_F4_1:
            r4 = 1.0f; code++; goto Next;
        case OpCode::Ldc_R4_F4_M1:
            r4 = -1.0f; code++; goto Next;
        case OpCode::Ldc_R4_F4_2:
            r4 = 2.0f; code++; goto Next;
        case OpCode::Ldc_R4_F4_05: // 0.5
            r4 = 0.5f; code++; goto Next;
        case OpCode::Ldc_R4_F4_M05: // -0.5
            r4 = -0.5f; code++; goto Next;

        case OpCode::Ldc_R4_X4: // <op> <4 byte value>
            r4 = *reinterpret_cast<const int32_t*>(code + 1); code += 3; goto Next;
        case OpCode::Ldc_R4_X8: // <op> <8 byte value>
            r4 = *reinterpret_cast<const int64_t*>(code + 1); code += 5; goto Next;
        ...
        case OpCode::Ldc_R5_F4_1:
            r5 = 1.0f; code++; goto Next;
        case OpCode::Ldc_R5_F4_M1:
            r5 = -1.0f; code++; goto Next;
        case OpCode::Ldc_R5_F4_2:
            r5 = 2.0f; code++; goto Next;
        case OpCode::Ldc_R5_F4_05: // 0.5
            r5 = 0.5f; code++; goto Next;
        case OpCode::Ldc_R5_F4_M05: // -0.5
            r5 = -0.5f; code++; goto Next;

        case OpCode::Ldc_R5_X4: // <op> <4 byte value>
            r5 = *reinterpret_cast<const int32_t*>(code + 1); code += 3; goto Next;
        case OpCode::Ldc_R5_X8: // <op> <8 byte value>
            r5 = *reinterpret_cast<const int64_t*>(code + 1); code += 5; goto Next;
        ...
        case OpCode::Ldc_R6_F4_1:
            r6 = 1.0f; code++; goto Next;
        case OpCode::Ldc_R6_F4_M1:
            r6 = -1.0f; code++; goto Next;
        case OpCode::Ldc_R6_F4_2:
            r6 = 2.0f; code++; goto Next;
        case OpCode::Ldc_R6_F4_05: // 0.5
            r6 = 0.5f; code++; goto Next;
        case OpCode::Ldc_R6_F4_M05: // -0.5
            r6 = -0.5f; code++; goto Next;

        case OpCode::Ldc_R6_X4: // <op> <4 byte value>
            r6 = *reinterpret_cast<const int32_t*>(code + 1); code += 3; goto Next;
        case OpCode::Ldc_R6_X8: // <op> <8 byte value>
            r6 = *reinterpret_cast<const int64_t*>(code + 1); code += 5; goto Next;
        ...
        case OpCode::Ldc_R7_F4_1:
            r7 = 1.0f; code++; goto Next;
        case OpCode::Ldc_R7_F4_M1:
            r7 = -1.0f; code++; goto Next;
        case OpCode::Ldc_R7_F4_2:
            r7 = 2.0f; code++; goto Next;
        case OpCode::Ldc_R7_F4_05: // 0.5
            r7 = 0.5f; code++; goto Next;
        case OpCode::Ldc_R7_F4_M05: // -0.5
            r7 = -0.5f; code++; goto Next;

        case OpCode::Ldc_R7_X4: // <op> <4 byte value>
            r7 = *reinterpret_cast<const int32_t*>(code + 1); code += 3; goto Next;
        case OpCode::Ldc_R7_X8: // <op> <8 byte value>
            r7 = *reinterpret_cast<const int64_t*>(code + 1); code += 5; goto Next;

        case OpCode::LdLoc_R0_X1: // <op> <u2 offset (4 byte step)>
            r0 = *reinterpret_cast<uint8_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R0_X2: // <op> <u2 offset (4 byte step)>
            r0 = *reinterpret_cast<uint16_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R0_X4: // <op> <u2 offset (4 byte step)>
            r0 = *reinterpret_cast<uint32_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R0_X8: // <op> <u2 offset (4 byte step)>
            r0 = *reinterpret_cast<uint64_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R1_X1: // <op> <u2 offset (4 byte step)>
            r1 = *reinterpret_cast<uint8_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R1_X2: // <op> <u2 offset (4 byte step)>
            r1 = *reinterpret_cast<uint16_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R1_X4: // <op> <u2 offset (4 byte step)>
            r1 = *reinterpret_cast<uint32_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R1_X8: // <op> <u2 offset (4 byte step)>
            r1 = *reinterpret_cast<uint64_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R2_X1: // <op> <u2 offset (4 byte step)>
            r2 = *reinterpret_cast<uint8_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R2_X2: // <op> <u2 offset (4 byte step)>
            r2 = *reinterpret_cast<uint16_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R2_X4: // <op> <u2 offset (4 byte step)>
            r2 = *reinterpret_cast<uint32_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R2_X8: // <op> <u2 offset (4 byte step)>
            r2 = *reinterpret_cast<uint64_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R3_X1: // <op> <u2 offset (4 byte step)>
            r3 = *reinterpret_cast<uint8_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R3_X2: // <op> <u2 offset (4 byte step)>
            r3 = *reinterpret_cast<uint16_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R3_X4: // <op> <u2 offset (4 byte step)>
            r3 = *reinterpret_cast<uint32_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R3_X8: // <op> <u2 offset (4 byte step)>
            r3 = *reinterpret_cast<uint64_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R4_X1: // <op> <u2 offset (4 byte step)>
            r4 = *reinterpret_cast<uint8_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R4_X2: // <op> <u2 offset (4 byte step)>
            r4 = *reinterpret_cast<uint16_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R4_X4: // <op> <u2 offset (4 byte step)>
            r4 = *reinterpret_cast<uint32_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R4_X8: // <op> <u2 offset (4 byte step)>
            r4 = *reinterpret_cast<uint64_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R5_X1: // <op> <u2 offset (4 byte step)>
            r5 = *reinterpret_cast<uint8_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R5_X2: // <op> <u2 offset (4 byte step)>
            r5 = *reinterpret_cast<uint16_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R5_X4: // <op> <u2 offset (4 byte step)>
            r5 = *reinterpret_cast<uint32_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R5_X8: // <op> <u2 offset (4 byte step)>
            r5 = *reinterpret_cast<uint64_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R6_X1: // <op> <u2 offset (4 byte step)>
            r6 = *reinterpret_cast<uint8_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R6_X2: // <op> <u2 offset (4 byte step)>
            r6 = *reinterpret_cast<uint16_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R6_X4: // <op> <u2 offset (4 byte step)>
            r6 = *reinterpret_cast<uint32_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R6_X8: // <op> <u2 offset (4 byte step)>
            r6 = *reinterpret_cast<uint64_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R7_X1: // <op> <u2 offset (4 byte step)>
            r7 = *reinterpret_cast<uint8_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R7_X2: // <op> <u2 offset (4 byte step)>
            r7 = *reinterpret_cast<uint16_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R7_X4: // <op> <u2 offset (4 byte step)>
            r7 = *reinterpret_cast<uint32_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLoc_R7_X8: // <op> <u2 offset (4 byte step)>
            r7 = *reinterpret_cast<uint64_t*>(stack + 4 * *(code + 1)); code += 2; goto Next;

        case OpCode::LdLocA_R0: // <op> <u2 offset (4 byte step)>
            r0 = reinterpret_cast<size_t>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLocA_R1: // <op> <u2 offset (4 byte step)>
            r1 = reinterpret_cast<size_t>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLocA_R2: // <op> <u2 offset (4 byte step)>
            r2 = reinterpret_cast<size_t>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLocA_R3: // <op> <u2 offset (4 byte step)>
            r3 = reinterpret_cast<size_t>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLocA_R4: // <op> <u2 offset (4 byte step)>
            r4 = reinterpret_cast<size_t>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLocA_R5: // <op> <u2 offset (4 byte step)>
            r5 = reinterpret_cast<size_t>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLocA_R6: // <op> <u2 offset (4 byte step)>
            r6 = reinterpret_cast<size_t>(stack + 4 * *(code + 1)); code += 2; goto Next;
        case OpCode::LdLocA_R7: // <op> <u2 offset (4 byte step)>
            r7 = reinterpret_cast<size_t>(stack + 4 * *(code + 1)); code += 2; goto Next;

        case OpCode::LdInd_R0_R0_X1:
            r0 = *reinterpret_cast<uint8_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R0_R0_X2:
            r0 = *reinterpret_cast<uint16_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R0_R0_X4:
            r0 = *reinterpret_cast<uint32_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R0_R0_X8:
            r0 = *reinterpret_cast<uint64_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R0_R1_X1:
            r0 = *reinterpret_cast<uint8_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R0_R1_X2:
            r0 = *reinterpret_cast<uint16_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R0_R1_X4:
            r0 = *reinterpret_cast<uint32_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R0_R1_X8:
            r0 = *reinterpret_cast<uint64_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R0_R2_X1:
            r0 = *reinterpret_cast<uint8_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R0_R2_X2:
            r0 = *reinterpret_cast<uint16_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R0_R2_X4:
            r0 = *reinterpret_cast<uint32_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R0_R2_X8:
            r0 = *reinterpret_cast<uint64_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R0_R3_X1:
            r0 = *reinterpret_cast<uint8_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R0_R3_X2:
            r0 = *reinterpret_cast<uint16_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R0_R3_X4:
            r0 = *reinterpret_cast<uint32_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R0_R3_X8:
            r0 = *reinterpret_cast<uint64_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R0_R4_X1:
            r0 = *reinterpret_cast<uint8_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R0_R4_X2:
            r0 = *reinterpret_cast<uint16_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R0_R4_X4:
            r0 = *reinterpret_cast<uint32_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R0_R4_X8:
            r0 = *reinterpret_cast<uint64_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R0_R5_X1:
            r0 = *reinterpret_cast<uint8_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R0_R5_X2:
            r0 = *reinterpret_cast<uint16_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R0_R5_X4:
            r0 = *reinterpret_cast<uint32_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R0_R5_X8:
            r0 = *reinterpret_cast<uint64_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R0_R6_X1:
            r0 = *reinterpret_cast<uint8_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R0_R6_X2:
            r0 = *reinterpret_cast<uint16_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R0_R6_X4:
            r0 = *reinterpret_cast<uint32_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R0_R6_X8:
            r0 = *reinterpret_cast<uint64_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R0_R7_X1:
            r0 = *reinterpret_cast<uint8_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R0_R7_X2:
            r0 = *reinterpret_cast<uint16_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R0_R7_X4:
            r0 = *reinterpret_cast<uint32_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R0_R7_X8:
            r0 = *reinterpret_cast<uint64_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R1_R0_X1:
            r1 = *reinterpret_cast<uint8_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R1_R0_X2:
            r1 = *reinterpret_cast<uint16_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R1_R0_X4:
            r1 = *reinterpret_cast<uint32_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R1_R0_X8:
            r1 = *reinterpret_cast<uint64_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R1_R1_X1:
            r1 = *reinterpret_cast<uint8_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R1_R1_X2:
            r1 = *reinterpret_cast<uint16_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R1_R1_X4:
            r1 = *reinterpret_cast<uint32_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R1_R1_X8:
            r1 = *reinterpret_cast<uint64_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R1_R2_X1:
            r1 = *reinterpret_cast<uint8_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R1_R2_X2:
            r1 = *reinterpret_cast<uint16_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R1_R2_X4:
            r1 = *reinterpret_cast<uint32_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R1_R2_X8:
            r1 = *reinterpret_cast<uint64_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R1_R3_X1:
            r1 = *reinterpret_cast<uint8_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R1_R3_X2:
            r1 = *reinterpret_cast<uint16_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R1_R3_X4:
            r1 = *reinterpret_cast<uint32_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R1_R3_X8:
            r1 = *reinterpret_cast<uint64_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R1_R4_X1:
            r1 = *reinterpret_cast<uint8_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R1_R4_X2:
            r1 = *reinterpret_cast<uint16_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R1_R4_X4:
            r1 = *reinterpret_cast<uint32_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R1_R4_X8:
            r1 = *reinterpret_cast<uint64_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R1_R5_X1:
            r1 = *reinterpret_cast<uint8_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R1_R5_X2:
            r1 = *reinterpret_cast<uint16_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R1_R5_X4:
            r1 = *reinterpret_cast<uint32_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R1_R5_X8:
            r1 = *reinterpret_cast<uint64_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R1_R6_X1:
            r1 = *reinterpret_cast<uint8_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R1_R6_X2:
            r1 = *reinterpret_cast<uint16_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R1_R6_X4:
            r1 = *reinterpret_cast<uint32_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R1_R6_X8:
            r1 = *reinterpret_cast<uint64_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R1_R7_X1:
            r1 = *reinterpret_cast<uint8_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R1_R7_X2:
            r1 = *reinterpret_cast<uint16_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R1_R7_X4:
            r1 = *reinterpret_cast<uint32_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R1_R7_X8:
            r1 = *reinterpret_cast<uint64_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R2_R0_X1:
            r2 = *reinterpret_cast<uint8_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R2_R0_X2:
            r2 = *reinterpret_cast<uint16_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R2_R0_X4:
            r2 = *reinterpret_cast<uint32_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R2_R0_X8:
            r2 = *reinterpret_cast<uint64_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R2_R1_X1:
            r2 = *reinterpret_cast<uint8_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R2_R1_X2:
            r2 = *reinterpret_cast<uint16_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R2_R1_X4:
            r2 = *reinterpret_cast<uint32_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R2_R1_X8:
            r2 = *reinterpret_cast<uint64_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R2_R2_X1:
            r2 = *reinterpret_cast<uint8_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R2_R2_X2:
            r2 = *reinterpret_cast<uint16_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R2_R2_X4:
            r2 = *reinterpret_cast<uint32_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R2_R2_X8:
            r2 = *reinterpret_cast<uint64_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R2_R3_X1:
            r2 = *reinterpret_cast<uint8_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R2_R3_X2:
            r2 = *reinterpret_cast<uint16_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R2_R3_X4:
            r2 = *reinterpret_cast<uint32_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R2_R3_X8:
            r2 = *reinterpret_cast<uint64_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R2_R4_X1:
            r2 = *reinterpret_cast<uint8_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R2_R4_X2:
            r2 = *reinterpret_cast<uint16_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R2_R4_X4:
            r2 = *reinterpret_cast<uint32_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R2_R4_X8:
            r2 = *reinterpret_cast<uint64_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R2_R5_X1:
            r2 = *reinterpret_cast<uint8_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R2_R5_X2:
            r2 = *reinterpret_cast<uint16_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R2_R5_X4:
            r2 = *reinterpret_cast<uint32_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R2_R5_X8:
            r2 = *reinterpret_cast<uint64_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R2_R6_X1:
            r2 = *reinterpret_cast<uint8_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R2_R6_X2:
            r2 = *reinterpret_cast<uint16_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R2_R6_X4:
            r2 = *reinterpret_cast<uint32_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R2_R6_X8:
            r2 = *reinterpret_cast<uint64_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R2_R7_X1:
            r2 = *reinterpret_cast<uint8_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R2_R7_X2:
            r2 = *reinterpret_cast<uint16_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R2_R7_X4:
            r2 = *reinterpret_cast<uint32_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R2_R7_X8:
            r2 = *reinterpret_cast<uint64_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R3_R0_X1:
            r3 = *reinterpret_cast<uint8_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R3_R0_X2:
            r3 = *reinterpret_cast<uint16_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R3_R0_X4:
            r3 = *reinterpret_cast<uint32_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R3_R0_X8:
            r3 = *reinterpret_cast<uint64_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R3_R1_X1:
            r3 = *reinterpret_cast<uint8_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R3_R1_X2:
            r3 = *reinterpret_cast<uint16_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R3_R1_X4:
            r3 = *reinterpret_cast<uint32_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R3_R1_X8:
            r3 = *reinterpret_cast<uint64_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R3_R2_X1:
            r3 = *reinterpret_cast<uint8_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R3_R2_X2:
            r3 = *reinterpret_cast<uint16_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R3_R2_X4:
            r3 = *reinterpret_cast<uint32_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R3_R2_X8:
            r3 = *reinterpret_cast<uint64_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R3_R3_X1:
            r3 = *reinterpret_cast<uint8_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R3_R3_X2:
            r3 = *reinterpret_cast<uint16_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R3_R3_X4:
            r3 = *reinterpret_cast<uint32_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R3_R3_X8:
            r3 = *reinterpret_cast<uint64_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R3_R4_X1:
            r3 = *reinterpret_cast<uint8_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R3_R4_X2:
            r3 = *reinterpret_cast<uint16_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R3_R4_X4:
            r3 = *reinterpret_cast<uint32_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R3_R4_X8:
            r3 = *reinterpret_cast<uint64_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R3_R5_X1:
            r3 = *reinterpret_cast<uint8_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R3_R5_X2:
            r3 = *reinterpret_cast<uint16_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R3_R5_X4:
            r3 = *reinterpret_cast<uint32_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R3_R5_X8:
            r3 = *reinterpret_cast<uint64_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R3_R6_X1:
            r3 = *reinterpret_cast<uint8_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R3_R6_X2:
            r3 = *reinterpret_cast<uint16_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R3_R6_X4:
            r3 = *reinterpret_cast<uint32_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R3_R6_X8:
            r3 = *reinterpret_cast<uint64_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R3_R7_X1:
            r3 = *reinterpret_cast<uint8_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R3_R7_X2:
            r3 = *reinterpret_cast<uint16_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R3_R7_X4:
            r3 = *reinterpret_cast<uint32_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R3_R7_X8:
            r3 = *reinterpret_cast<uint64_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R4_R0_X1:
            r4 = *reinterpret_cast<uint8_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R4_R0_X2:
            r4 = *reinterpret_cast<uint16_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R4_R0_X4:
            r4 = *reinterpret_cast<uint32_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R4_R0_X8:
            r4 = *reinterpret_cast<uint64_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R4_R1_X1:
            r4 = *reinterpret_cast<uint8_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R4_R1_X2:
            r4 = *reinterpret_cast<uint16_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R4_R1_X4:
            r4 = *reinterpret_cast<uint32_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R4_R1_X8:
            r4 = *reinterpret_cast<uint64_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R4_R2_X1:
            r4 = *reinterpret_cast<uint8_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R4_R2_X2:
            r4 = *reinterpret_cast<uint16_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R4_R2_X4:
            r4 = *reinterpret_cast<uint32_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R4_R2_X8:
            r4 = *reinterpret_cast<uint64_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R4_R3_X1:
            r4 = *reinterpret_cast<uint8_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R4_R3_X2:
            r4 = *reinterpret_cast<uint16_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R4_R3_X4:
            r4 = *reinterpret_cast<uint32_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R4_R3_X8:
            r4 = *reinterpret_cast<uint64_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R4_R4_X1:
            r4 = *reinterpret_cast<uint8_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R4_R4_X2:
            r4 = *reinterpret_cast<uint16_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R4_R4_X4:
            r4 = *reinterpret_cast<uint32_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R4_R4_X8:
            r4 = *reinterpret_cast<uint64_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R4_R5_X1:
            r4 = *reinterpret_cast<uint8_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R4_R5_X2:
            r4 = *reinterpret_cast<uint16_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R4_R5_X4:
            r4 = *reinterpret_cast<uint32_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R4_R5_X8:
            r4 = *reinterpret_cast<uint64_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R4_R6_X1:
            r4 = *reinterpret_cast<uint8_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R4_R6_X2:
            r4 = *reinterpret_cast<uint16_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R4_R6_X4:
            r4 = *reinterpret_cast<uint32_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R4_R6_X8:
            r4 = *reinterpret_cast<uint64_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R4_R7_X1:
            r4 = *reinterpret_cast<uint8_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R4_R7_X2:
            r4 = *reinterpret_cast<uint16_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R4_R7_X4:
            r4 = *reinterpret_cast<uint32_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R4_R7_X8:
            r4 = *reinterpret_cast<uint64_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R5_R0_X1:
            r5 = *reinterpret_cast<uint8_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R5_R0_X2:
            r5 = *reinterpret_cast<uint16_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R5_R0_X4:
            r5 = *reinterpret_cast<uint32_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R5_R0_X8:
            r5 = *reinterpret_cast<uint64_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R5_R1_X1:
            r5 = *reinterpret_cast<uint8_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R5_R1_X2:
            r5 = *reinterpret_cast<uint16_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R5_R1_X4:
            r5 = *reinterpret_cast<uint32_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R5_R1_X8:
            r5 = *reinterpret_cast<uint64_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R5_R2_X1:
            r5 = *reinterpret_cast<uint8_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R5_R2_X2:
            r5 = *reinterpret_cast<uint16_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R5_R2_X4:
            r5 = *reinterpret_cast<uint32_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R5_R2_X8:
            r5 = *reinterpret_cast<uint64_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R5_R3_X1:
            r5 = *reinterpret_cast<uint8_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R5_R3_X2:
            r5 = *reinterpret_cast<uint16_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R5_R3_X4:
            r5 = *reinterpret_cast<uint32_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R5_R3_X8:
            r5 = *reinterpret_cast<uint64_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R5_R4_X1:
            r5 = *reinterpret_cast<uint8_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R5_R4_X2:
            r5 = *reinterpret_cast<uint16_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R5_R4_X4:
            r5 = *reinterpret_cast<uint32_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R5_R4_X8:
            r5 = *reinterpret_cast<uint64_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R5_R5_X1:
            r5 = *reinterpret_cast<uint8_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R5_R5_X2:
            r5 = *reinterpret_cast<uint16_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R5_R5_X4:
            r5 = *reinterpret_cast<uint32_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R5_R5_X8:
            r5 = *reinterpret_cast<uint64_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R5_R6_X1:
            r5 = *reinterpret_cast<uint8_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R5_R6_X2:
            r5 = *reinterpret_cast<uint16_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R5_R6_X4:
            r5 = *reinterpret_cast<uint32_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R5_R6_X8:
            r5 = *reinterpret_cast<uint64_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R5_R7_X1:
            r5 = *reinterpret_cast<uint8_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R5_R7_X2:
            r5 = *reinterpret_cast<uint16_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R5_R7_X4:
            r5 = *reinterpret_cast<uint32_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R5_R7_X8:
            r5 = *reinterpret_cast<uint64_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R6_R0_X1:
            r6 = *reinterpret_cast<uint8_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R6_R0_X2:
            r6 = *reinterpret_cast<uint16_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R6_R0_X4:
            r6 = *reinterpret_cast<uint32_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R6_R0_X8:
            r6 = *reinterpret_cast<uint64_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R6_R1_X1:
            r6 = *reinterpret_cast<uint8_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R6_R1_X2:
            r6 = *reinterpret_cast<uint16_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R6_R1_X4:
            r6 = *reinterpret_cast<uint32_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R6_R1_X8:
            r6 = *reinterpret_cast<uint64_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R6_R2_X1:
            r6 = *reinterpret_cast<uint8_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R6_R2_X2:
            r6 = *reinterpret_cast<uint16_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R6_R2_X4:
            r6 = *reinterpret_cast<uint32_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R6_R2_X8:
            r6 = *reinterpret_cast<uint64_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R6_R3_X1:
            r6 = *reinterpret_cast<uint8_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R6_R3_X2:
            r6 = *reinterpret_cast<uint16_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R6_R3_X4:
            r6 = *reinterpret_cast<uint32_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R6_R3_X8:
            r6 = *reinterpret_cast<uint64_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R6_R4_X1:
            r6 = *reinterpret_cast<uint8_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R6_R4_X2:
            r6 = *reinterpret_cast<uint16_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R6_R4_X4:
            r6 = *reinterpret_cast<uint32_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R6_R4_X8:
            r6 = *reinterpret_cast<uint64_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R6_R5_X1:
            r6 = *reinterpret_cast<uint8_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R6_R5_X2:
            r6 = *reinterpret_cast<uint16_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R6_R5_X4:
            r6 = *reinterpret_cast<uint32_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R6_R5_X8:
            r6 = *reinterpret_cast<uint64_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R6_R6_X1:
            r6 = *reinterpret_cast<uint8_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R6_R6_X2:
            r6 = *reinterpret_cast<uint16_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R6_R6_X4:
            r6 = *reinterpret_cast<uint32_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R6_R6_X8:
            r6 = *reinterpret_cast<uint64_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R6_R7_X1:
            r6 = *reinterpret_cast<uint8_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R6_R7_X2:
            r6 = *reinterpret_cast<uint16_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R6_R7_X4:
            r6 = *reinterpret_cast<uint32_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R6_R7_X8:
            r6 = *reinterpret_cast<uint64_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R7_R0_X1:
            r7 = *reinterpret_cast<uint8_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R7_R0_X2:
            r7 = *reinterpret_cast<uint16_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R7_R0_X4:
            r7 = *reinterpret_cast<uint32_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R7_R0_X8:
            r7 = *reinterpret_cast<uint64_t*>(r0.usize); code++; goto Next;
        case OpCode::LdInd_R7_R1_X1:
            r7 = *reinterpret_cast<uint8_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R7_R1_X2:
            r7 = *reinterpret_cast<uint16_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R7_R1_X4:
            r7 = *reinterpret_cast<uint32_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R7_R1_X8:
            r7 = *reinterpret_cast<uint64_t*>(r1.usize); code++; goto Next;
        case OpCode::LdInd_R7_R2_X1:
            r7 = *reinterpret_cast<uint8_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R7_R2_X2:
            r7 = *reinterpret_cast<uint16_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R7_R2_X4:
            r7 = *reinterpret_cast<uint32_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R7_R2_X8:
            r7 = *reinterpret_cast<uint64_t*>(r2.usize); code++; goto Next;
        case OpCode::LdInd_R7_R3_X1:
            r7 = *reinterpret_cast<uint8_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R7_R3_X2:
            r7 = *reinterpret_cast<uint16_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R7_R3_X4:
            r7 = *reinterpret_cast<uint32_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R7_R3_X8:
            r7 = *reinterpret_cast<uint64_t*>(r3.usize); code++; goto Next;
        case OpCode::LdInd_R7_R4_X1:
            r7 = *reinterpret_cast<uint8_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R7_R4_X2:
            r7 = *reinterpret_cast<uint16_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R7_R4_X4:
            r7 = *reinterpret_cast<uint32_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R7_R4_X8:
            r7 = *reinterpret_cast<uint64_t*>(r4.usize); code++; goto Next;
        case OpCode::LdInd_R7_R5_X1:
            r7 = *reinterpret_cast<uint8_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R7_R5_X2:
            r7 = *reinterpret_cast<uint16_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R7_R5_X4:
            r7 = *reinterpret_cast<uint32_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R7_R5_X8:
            r7 = *reinterpret_cast<uint64_t*>(r5.usize); code++; goto Next;
        case OpCode::LdInd_R7_R6_X1:
            r7 = *reinterpret_cast<uint8_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R7_R6_X2:
            r7 = *reinterpret_cast<uint16_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R7_R6_X4:
            r7 = *reinterpret_cast<uint32_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R7_R6_X8:
            r7 = *reinterpret_cast<uint64_t*>(r6.usize); code++; goto Next;
        case OpCode::LdInd_R7_R7_X1:
            r7 = *reinterpret_cast<uint8_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R7_R7_X2:
            r7 = *reinterpret_cast<uint16_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R7_R7_X4:
            r7 = *reinterpret_cast<uint32_t*>(r7.usize); code++; goto Next;
        case OpCode::LdInd_R7_R7_X8:
            r7 = *reinterpret_cast<uint64_t*>(r7.usize); code++; goto Next;

        case OpCode::StInd_R0_R0_X1:
            *reinterpret_cast<uint8_t*>(r0.usize) = r0.u8; code++; goto Next;
        case OpCode::StInd_R0_R0_X2:
            *reinterpret_cast<uint16_t*>(r0.usize) = r0.u16; code++; goto Next;
        case OpCode::StInd_R0_R0_X4:
            *reinterpret_cast<uint32_t*>(r0.usize) = r0.u32; code++; goto Next;
        case OpCode::StInd_R0_R0_X8:
            *reinterpret_cast<uint64_t*>(r0.usize) = r0.u64; code++; goto Next;
        case OpCode::StInd_R0_R1_X1:
            *reinterpret_cast<uint8_t*>(r0.usize) = r1.u8; code++; goto Next;
        case OpCode::StInd_R0_R1_X2:
            *reinterpret_cast<uint16_t*>(r0.usize) = r1.u16; code++; goto Next;
        case OpCode::StInd_R0_R1_X4:
            *reinterpret_cast<uint32_t*>(r0.usize) = r1.u32; code++; goto Next;
        case OpCode::StInd_R0_R1_X8:
            *reinterpret_cast<uint64_t*>(r0.usize) = r1.u64; code++; goto Next;
        case OpCode::StInd_R0_R2_X1:
            *reinterpret_cast<uint8_t*>(r0.usize) = r2.u8; code++; goto Next;
        case OpCode::StInd_R0_R2_X2:
            *reinterpret_cast<uint16_t*>(r0.usize) = r2.u16; code++; goto Next;
        case OpCode::StInd_R0_R2_X4:
            *reinterpret_cast<uint32_t*>(r0.usize) = r2.u32; code++; goto Next;
        case OpCode::StInd_R0_R2_X8:
            *reinterpret_cast<uint64_t*>(r0.usize) = r2.u64; code++; goto Next;
        case OpCode::StInd_R0_R3_X1:
            *reinterpret_cast<uint8_t*>(r0.usize) = r3.u8; code++; goto Next;
        case OpCode::StInd_R0_R3_X2:
            *reinterpret_cast<uint16_t*>(r0.usize) = r3.u16; code++; goto Next;
        case OpCode::StInd_R0_R3_X4:
            *reinterpret_cast<uint32_t*>(r0.usize) = r3.u32; code++; goto Next;
        case OpCode::StInd_R0_R3_X8:
            *reinterpret_cast<uint64_t*>(r0.usize) = r3.u64; code++; goto Next;
        case OpCode::StInd_R0_R4_X1:
            *reinterpret_cast<uint8_t*>(r0.usize) = r4.u8; code++; goto Next;
        case OpCode::StInd_R0_R4_X2:
            *reinterpret_cast<uint16_t*>(r0.usize) = r4.u16; code++; goto Next;
        case OpCode::StInd_R0_R4_X4:
            *reinterpret_cast<uint32_t*>(r0.usize) = r4.u32; code++; goto Next;
        case OpCode::StInd_R0_R4_X8:
            *reinterpret_cast<uint64_t*>(r0.usize) = r4.u64; code++; goto Next;
        case OpCode::StInd_R0_R5_X1:
            *reinterpret_cast<uint8_t*>(r0.usize) = r5.u8; code++; goto Next;
        case OpCode::StInd_R0_R5_X2:
            *reinterpret_cast<uint16_t*>(r0.usize) = r5.u16; code++; goto Next;
        case OpCode::StInd_R0_R5_X4:
            *reinterpret_cast<uint32_t*>(r0.usize) = r5.u32; code++; goto Next;
        case OpCode::StInd_R0_R5_X8:
            *reinterpret_cast<uint64_t*>(r0.usize) = r5.u64; code++; goto Next;
        case OpCode::StInd_R0_R6_X1:
            *reinterpret_cast<uint8_t*>(r0.usize) = r6.u8; code++; goto Next;
        case OpCode::StInd_R0_R6_X2:
            *reinterpret_cast<uint16_t*>(r0.usize) = r6.u16; code++; goto Next;
        case OpCode::StInd_R0_R6_X4:
            *reinterpret_cast<uint32_t*>(r0.usize) = r6.u32; code++; goto Next;
        case OpCode::StInd_R0_R6_X8:
            *reinterpret_cast<uint64_t*>(r0.usize) = r6.u64; code++; goto Next;
        case OpCode::StInd_R0_R7_X1:
            *reinterpret_cast<uint8_t*>(r0.usize) = r7.u8; code++; goto Next;
        case OpCode::StInd_R0_R7_X2:
            *reinterpret_cast<uint16_t*>(r0.usize) = r7.u16; code++; goto Next;
        case OpCode::StInd_R0_R7_X4:
            *reinterpret_cast<uint32_t*>(r0.usize) = r7.u32; code++; goto Next;
        case OpCode::StInd_R0_R7_X8:
            *reinterpret_cast<uint64_t*>(r0.usize) = r7.u64; code++; goto Next;
        case OpCode::StInd_R1_R0_X1:
            *reinterpret_cast<uint8_t*>(r1.usize) = r0.u8; code++; goto Next;
        case OpCode::StInd_R1_R0_X2:
            *reinterpret_cast<uint16_t*>(r1.usize) = r0.u16; code++; goto Next;
        case OpCode::StInd_R1_R0_X4:
            *reinterpret_cast<uint32_t*>(r1.usize) = r0.u32; code++; goto Next;
        case OpCode::StInd_R1_R0_X8:
            *reinterpret_cast<uint64_t*>(r1.usize) = r0.u64; code++; goto Next;
        case OpCode::StInd_R1_R1_X1:
            *reinterpret_cast<uint8_t*>(r1.usize) = r1.u8; code++; goto Next;
        case OpCode::StInd_R1_R1_X2:
            *reinterpret_cast<uint16_t*>(r1.usize) = r1.u16; code++; goto Next;
        case OpCode::StInd_R1_R1_X4:
            *reinterpret_cast<uint32_t*>(r1.usize) = r1.u32; code++; goto Next;
        case OpCode::StInd_R1_R1_X8:
            *reinterpret_cast<uint64_t*>(r1.usize) = r1.u64; code++; goto Next;
        case OpCode::StInd_R1_R2_X1:
            *reinterpret_cast<uint8_t*>(r1.usize) = r2.u8; code++; goto Next;
        case OpCode::StInd_R1_R2_X2:
            *reinterpret_cast<uint16_t*>(r1.usize) = r2.u16; code++; goto Next;
        case OpCode::StInd_R1_R2_X4:
            *reinterpret_cast<uint32_t*>(r1.usize) = r2.u32; code++; goto Next;
        case OpCode::StInd_R1_R2_X8:
            *reinterpret_cast<uint64_t*>(r1.usize) = r2.u64; code++; goto Next;
        case OpCode::StInd_R1_R3_X1:
            *reinterpret_cast<uint8_t*>(r1.usize) = r3.u8; code++; goto Next;
        case OpCode::StInd_R1_R3_X2:
            *reinterpret_cast<uint16_t*>(r1.usize) = r3.u16; code++; goto Next;
        case OpCode::StInd_R1_R3_X4:
            *reinterpret_cast<uint32_t*>(r1.usize) = r3.u32; code++; goto Next;
        case OpCode::StInd_R1_R3_X8:
            *reinterpret_cast<uint64_t*>(r1.usize) = r3.u64; code++; goto Next;
        case OpCode::StInd_R1_R4_X1:
            *reinterpret_cast<uint8_t*>(r1.usize) = r4.u8; code++; goto Next;
        case OpCode::StInd_R1_R4_X2:
            *reinterpret_cast<uint16_t*>(r1.usize) = r4.u16; code++; goto Next;
        case OpCode::StInd_R1_R4_X4:
            *reinterpret_cast<uint32_t*>(r1.usize) = r4.u32; code++; goto Next;
        case OpCode::StInd_R1_R4_X8:
            *reinterpret_cast<uint64_t*>(r1.usize) = r4.u64; code++; goto Next;
        case OpCode::StInd_R1_R5_X1:
            *reinterpret_cast<uint8_t*>(r1.usize) = r5.u8; code++; goto Next;
        case OpCode::StInd_R1_R5_X2:
            *reinterpret_cast<uint16_t*>(r1.usize) = r5.u16; code++; goto Next;
        case OpCode::StInd_R1_R5_X4:
            *reinterpret_cast<uint32_t*>(r1.usize) = r5.u32; code++; goto Next;
        case OpCode::StInd_R1_R5_X8:
            *reinterpret_cast<uint64_t*>(r1.usize) = r5.u64; code++; goto Next;
        case OpCode::StInd_R1_R6_X1:
            *reinterpret_cast<uint8_t*>(r1.usize) = r6.u8; code++; goto Next;
        case OpCode::StInd_R1_R6_X2:
            *reinterpret_cast<uint16_t*>(r1.usize) = r6.u16; code++; goto Next;
        case OpCode::StInd_R1_R6_X4:
            *reinterpret_cast<uint32_t*>(r1.usize) = r6.u32; code++; goto Next;
        case OpCode::StInd_R1_R6_X8:
            *reinterpret_cast<uint64_t*>(r1.usize) = r6.u64; code++; goto Next;
        case OpCode::StInd_R1_R7_X1:
            *reinterpret_cast<uint8_t*>(r1.usize) = r7.u8; code++; goto Next;
        case OpCode::StInd_R1_R7_X2:
            *reinterpret_cast<uint16_t*>(r1.usize) = r7.u16; code++; goto Next;
        case OpCode::StInd_R1_R7_X4:
            *reinterpret_cast<uint32_t*>(r1.usize) = r7.u32; code++; goto Next;
        case OpCode::StInd_R1_R7_X8:
            *reinterpret_cast<uint64_t*>(r1.usize) = r7.u64; code++; goto Next;
        case OpCode::StInd_R2_R0_X1:
            *reinterpret_cast<uint8_t*>(r2.usize) = r0.u8; code++; goto Next;
        case OpCode::StInd_R2_R0_X2:
            *reinterpret_cast<uint16_t*>(r2.usize) = r0.u16; code++; goto Next;
        case OpCode::StInd_R2_R0_X4:
            *reinterpret_cast<uint32_t*>(r2.usize) = r0.u32; code++; goto Next;
        case OpCode::StInd_R2_R0_X8:
            *reinterpret_cast<uint64_t*>(r2.usize) = r0.u64; code++; goto Next;
        case OpCode::StInd_R2_R1_X1:
            *reinterpret_cast<uint8_t*>(r2.usize) = r1.u8; code++; goto Next;
        case OpCode::StInd_R2_R1_X2:
            *reinterpret_cast<uint16_t*>(r2.usize) = r1.u16; code++; goto Next;
        case OpCode::StInd_R2_R1_X4:
            *reinterpret_cast<uint32_t*>(r2.usize) = r1.u32; code++; goto Next;
        case OpCode::StInd_R2_R1_X8:
            *reinterpret_cast<uint64_t*>(r2.usize) = r1.u64; code++; goto Next;
        case OpCode::StInd_R2_R2_X1:
            *reinterpret_cast<uint8_t*>(r2.usize) = r2.u8; code++; goto Next;
        case OpCode::StInd_R2_R2_X2:
            *reinterpret_cast<uint16_t*>(r2.usize) = r2.u16; code++; goto Next;
        case OpCode::StInd_R2_R2_X4:
            *reinterpret_cast<uint32_t*>(r2.usize) = r2.u32; code++; goto Next;
        case OpCode::StInd_R2_R2_X8:
            *reinterpret_cast<uint64_t*>(r2.usize) = r2.u64; code++; goto Next;
        case OpCode::StInd_R2_R3_X1:
            *reinterpret_cast<uint8_t*>(r2.usize) = r3.u8; code++; goto Next;
        case OpCode::StInd_R2_R3_X2:
            *reinterpret_cast<uint16_t*>(r2.usize) = r3.u16; code++; goto Next;
        case OpCode::StInd_R2_R3_X4:
            *reinterpret_cast<uint32_t*>(r2.usize) = r3.u32; code++; goto Next;
        case OpCode::StInd_R2_R3_X8:
            *reinterpret_cast<uint64_t*>(r2.usize) = r3.u64; code++; goto Next;
        case OpCode::StInd_R2_R4_X1:
            *reinterpret_cast<uint8_t*>(r2.usize) = r4.u8; code++; goto Next;
        case OpCode::StInd_R2_R4_X2:
            *reinterpret_cast<uint16_t*>(r2.usize) = r4.u16; code++; goto Next;
        case OpCode::StInd_R2_R4_X4:
            *reinterpret_cast<uint32_t*>(r2.usize) = r4.u32; code++; goto Next;
        case OpCode::StInd_R2_R4_X8:
            *reinterpret_cast<uint64_t*>(r2.usize) = r4.u64; code++; goto Next;
        case OpCode::StInd_R2_R5_X1:
            *reinterpret_cast<uint8_t*>(r2.usize) = r5.u8; code++; goto Next;
        case OpCode::StInd_R2_R5_X2:
            *reinterpret_cast<uint16_t*>(r2.usize) = r5.u16; code++; goto Next;
        case OpCode::StInd_R2_R5_X4:
            *reinterpret_cast<uint32_t*>(r2.usize) = r5.u32; code++; goto Next;
        case OpCode::StInd_R2_R5_X8:
            *reinterpret_cast<uint64_t*>(r2.usize) = r5.u64; code++; goto Next;
        case OpCode::StInd_R2_R6_X1:
            *reinterpret_cast<uint8_t*>(r2.usize) = r6.u8; code++; goto Next;
        case OpCode::StInd_R2_R6_X2:
            *reinterpret_cast<uint16_t*>(r2.usize) = r6.u16; code++; goto Next;
        case OpCode::StInd_R2_R6_X4:
            *reinterpret_cast<uint32_t*>(r2.usize) = r6.u32; code++; goto Next;
        case OpCode::StInd_R2_R6_X8:
            *reinterpret_cast<uint64_t*>(r2.usize) = r6.u64; code++; goto Next;
        case OpCode::StInd_R2_R7_X1:
            *reinterpret_cast<uint8_t*>(r2.usize) = r7.u8; code++; goto Next;
        case OpCode::StInd_R2_R7_X2:
            *reinterpret_cast<uint16_t*>(r2.usize) = r7.u16; code++; goto Next;
        case OpCode::StInd_R2_R7_X4:
            *reinterpret_cast<uint32_t*>(r2.usize) = r7.u32; code++; goto Next;
        case OpCode::StInd_R2_R7_X8:
            *reinterpret_cast<uint64_t*>(r2.usize) = r7.u64; code++; goto Next;
        case OpCode::StInd_R3_R0_X1:
            *reinterpret_cast<uint8_t*>(r3.usize) = r0.u8; code++; goto Next;
        case OpCode::StInd_R3_R0_X2:
            *reinterpret_cast<uint16_t*>(r3.usize) = r0.u16; code++; goto Next;
        case OpCode::StInd_R3_R0_X4:
            *reinterpret_cast<uint32_t*>(r3.usize) = r0.u32; code++; goto Next;
        case OpCode::StInd_R3_R0_X8:
            *reinterpret_cast<uint64_t*>(r3.usize) = r0.u64; code++; goto Next;
        case OpCode::StInd_R3_R1_X1:
            *reinterpret_cast<uint8_t*>(r3.usize) = r1.u8; code++; goto Next;
        case OpCode::StInd_R3_R1_X2:
            *reinterpret_cast<uint16_t*>(r3.usize) = r1.u16; code++; goto Next;
        case OpCode::StInd_R3_R1_X4:
            *reinterpret_cast<uint32_t*>(r3.usize) = r1.u32; code++; goto Next;
        case OpCode::StInd_R3_R1_X8:
            *reinterpret_cast<uint64_t*>(r3.usize) = r1.u64; code++; goto Next;
        case OpCode::StInd_R3_R2_X1:
            *reinterpret_cast<uint8_t*>(r3.usize) = r2.u8; code++; goto Next;
        case OpCode::StInd_R3_R2_X2:
            *reinterpret_cast<uint16_t*>(r3.usize) = r2.u16; code++; goto Next;
        case OpCode::StInd_R3_R2_X4:
            *reinterpret_cast<uint32_t*>(r3.usize) = r2.u32; code++; goto Next;
        case OpCode::StInd_R3_R2_X8:
            *reinterpret_cast<uint64_t*>(r3.usize) = r2.u64; code++; goto Next;
        case OpCode::StInd_R3_R3_X1:
            *reinterpret_cast<uint8_t*>(r3.usize) = r3.u8; code++; goto Next;
        case OpCode::StInd_R3_R3_X2:
            *reinterpret_cast<uint16_t*>(r3.usize) = r3.u16; code++; goto Next;
        case OpCode::StInd_R3_R3_X4:
            *reinterpret_cast<uint32_t*>(r3.usize) = r3.u32; code++; goto Next;
        case OpCode::StInd_R3_R3_X8:
            *reinterpret_cast<uint64_t*>(r3.usize) = r3.u64; code++; goto Next;
        case OpCode::StInd_R3_R4_X1:
            *reinterpret_cast<uint8_t*>(r3.usize) = r4.u8; code++; goto Next;
        case OpCode::StInd_R3_R4_X2:
            *reinterpret_cast<uint16_t*>(r3.usize) = r4.u16; code++; goto Next;
        case OpCode::StInd_R3_R4_X4:
            *reinterpret_cast<uint32_t*>(r3.usize) = r4.u32; code++; goto Next;
        case OpCode::StInd_R3_R4_X8:
            *reinterpret_cast<uint64_t*>(r3.usize) = r4.u64; code++; goto Next;
        case OpCode::StInd_R3_R5_X1:
            *reinterpret_cast<uint8_t*>(r3.usize) = r5.u8; code++; goto Next;
        case OpCode::StInd_R3_R5_X2:
            *reinterpret_cast<uint16_t*>(r3.usize) = r5.u16; code++; goto Next;
        case OpCode::StInd_R3_R5_X4:
            *reinterpret_cast<uint32_t*>(r3.usize) = r5.u32; code++; goto Next;
        case OpCode::StInd_R3_R5_X8:
            *reinterpret_cast<uint64_t*>(r3.usize) = r5.u64; code++; goto Next;
        case OpCode::StInd_R3_R6_X1:
            *reinterpret_cast<uint8_t*>(r3.usize) = r6.u8; code++; goto Next;
        case OpCode::StInd_R3_R6_X2:
            *reinterpret_cast<uint16_t*>(r3.usize) = r6.u16; code++; goto Next;
        case OpCode::StInd_R3_R6_X4:
            *reinterpret_cast<uint32_t*>(r3.usize) = r6.u32; code++; goto Next;
        case OpCode::StInd_R3_R6_X8:
            *reinterpret_cast<uint64_t*>(r3.usize) = r6.u64; code++; goto Next;
        case OpCode::StInd_R3_R7_X1:
            *reinterpret_cast<uint8_t*>(r3.usize) = r7.u8; code++; goto Next;
        case OpCode::StInd_R3_R7_X2:
            *reinterpret_cast<uint16_t*>(r3.usize) = r7.u16; code++; goto Next;
        case OpCode::StInd_R3_R7_X4:
            *reinterpret_cast<uint32_t*>(r3.usize) = r7.u32; code++; goto Next;
        case OpCode::StInd_R3_R7_X8:
            *reinterpret_cast<uint64_t*>(r3.usize) = r7.u64; code++; goto Next;
        case OpCode::StInd_R4_R0_X1:
            *reinterpret_cast<uint8_t*>(r4.usize) = r0.u8; code++; goto Next;
        case OpCode::StInd_R4_R0_X2:
            *reinterpret_cast<uint16_t*>(r4.usize) = r0.u16; code++; goto Next;
        case OpCode::StInd_R4_R0_X4:
            *reinterpret_cast<uint32_t*>(r4.usize) = r0.u32; code++; goto Next;
        case OpCode::StInd_R4_R0_X8:
            *reinterpret_cast<uint64_t*>(r4.usize) = r0.u64; code++; goto Next;
        case OpCode::StInd_R4_R1_X1:
            *reinterpret_cast<uint8_t*>(r4.usize) = r1.u8; code++; goto Next;
        case OpCode::StInd_R4_R1_X2:
            *reinterpret_cast<uint16_t*>(r4.usize) = r1.u16; code++; goto Next;
        case OpCode::StInd_R4_R1_X4:
            *reinterpret_cast<uint32_t*>(r4.usize) = r1.u32; code++; goto Next;
        case OpCode::StInd_R4_R1_X8:
            *reinterpret_cast<uint64_t*>(r4.usize) = r1.u64; code++; goto Next;
        case OpCode::StInd_R4_R2_X1:
            *reinterpret_cast<uint8_t*>(r4.usize) = r2.u8; code++; goto Next;
        case OpCode::StInd_R4_R2_X2:
            *reinterpret_cast<uint16_t*>(r4.usize) = r2.u16; code++; goto Next;
        case OpCode::StInd_R4_R2_X4:
            *reinterpret_cast<uint32_t*>(r4.usize) = r2.u32; code++; goto Next;
        case OpCode::StInd_R4_R2_X8:
            *reinterpret_cast<uint64_t*>(r4.usize) = r2.u64; code++; goto Next;
        case OpCode::StInd_R4_R3_X1:
            *reinterpret_cast<uint8_t*>(r4.usize) = r3.u8; code++; goto Next;
        case OpCode::StInd_R4_R3_X2:
            *reinterpret_cast<uint16_t*>(r4.usize) = r3.u16; code++; goto Next;
        case OpCode::StInd_R4_R3_X4:
            *reinterpret_cast<uint32_t*>(r4.usize) = r3.u32; code++; goto Next;
        case OpCode::StInd_R4_R3_X8:
            *reinterpret_cast<uint64_t*>(r4.usize) = r3.u64; code++; goto Next;
        case OpCode::StInd_R4_R4_X1:
            *reinterpret_cast<uint8_t*>(r4.usize) = r4.u8; code++; goto Next;
        case OpCode::StInd_R4_R4_X2:
            *reinterpret_cast<uint16_t*>(r4.usize) = r4.u16; code++; goto Next;
        case OpCode::StInd_R4_R4_X4:
            *reinterpret_cast<uint32_t*>(r4.usize) = r4.u32; code++; goto Next;
        case OpCode::StInd_R4_R4_X8:
            *reinterpret_cast<uint64_t*>(r4.usize) = r4.u64; code++; goto Next;
        case OpCode::StInd_R4_R5_X1:
            *reinterpret_cast<uint8_t*>(r4.usize) = r5.u8; code++; goto Next;
        case OpCode::StInd_R4_R5_X2:
            *reinterpret_cast<uint16_t*>(r4.usize) = r5.u16; code++; goto Next;
        case OpCode::StInd_R4_R5_X4:
            *reinterpret_cast<uint32_t*>(r4.usize) = r5.u32; code++; goto Next;
        case OpCode::StInd_R4_R5_X8:
            *reinterpret_cast<uint64_t*>(r4.usize) = r5.u64; code++; goto Next;
        case OpCode::StInd_R4_R6_X1:
            *reinterpret_cast<uint8_t*>(r4.usize) = r6.u8; code++; goto Next;
        case OpCode::StInd_R4_R6_X2:
            *reinterpret_cast<uint16_t*>(r4.usize) = r6.u16; code++; goto Next;
        case OpCode::StInd_R4_R6_X4:
            *reinterpret_cast<uint32_t*>(r4.usize) = r6.u32; code++; goto Next;
        case OpCode::StInd_R4_R6_X8:
            *reinterpret_cast<uint64_t*>(r4.usize) = r6.u64; code++; goto Next;
        case OpCode::StInd_R4_R7_X1:
            *reinterpret_cast<uint8_t*>(r4.usize) = r7.u8; code++; goto Next;
        case OpCode::StInd_R4_R7_X2:
            *reinterpret_cast<uint16_t*>(r4.usize) = r7.u16; code++; goto Next;
        case OpCode::StInd_R4_R7_X4:
            *reinterpret_cast<uint32_t*>(r4.usize) = r7.u32; code++; goto Next;
        case OpCode::StInd_R4_R7_X8:
            *reinterpret_cast<uint64_t*>(r4.usize) = r7.u64; code++; goto Next;
        case OpCode::StInd_R5_R0_X1:
            *reinterpret_cast<uint8_t*>(r5.usize) = r0.u8; code++; goto Next;
        case OpCode::StInd_R5_R0_X2:
            *reinterpret_cast<uint16_t*>(r5.usize) = r0.u16; code++; goto Next;
        case OpCode::StInd_R5_R0_X4:
            *reinterpret_cast<uint32_t*>(r5.usize) = r0.u32; code++; goto Next;
        case OpCode::StInd_R5_R0_X8:
            *reinterpret_cast<uint64_t*>(r5.usize) = r0.u64; code++; goto Next;
        case OpCode::StInd_R5_R1_X1:
            *reinterpret_cast<uint8_t*>(r5.usize) = r1.u8; code++; goto Next;
        case OpCode::StInd_R5_R1_X2:
            *reinterpret_cast<uint16_t*>(r5.usize) = r1.u16; code++; goto Next;
        case OpCode::StInd_R5_R1_X4:
            *reinterpret_cast<uint32_t*>(r5.usize) = r1.u32; code++; goto Next;
        case OpCode::StInd_R5_R1_X8:
            *reinterpret_cast<uint64_t*>(r5.usize) = r1.u64; code++; goto Next;
        case OpCode::StInd_R5_R2_X1:
            *reinterpret_cast<uint8_t*>(r5.usize) = r2.u8; code++; goto Next;
        case OpCode::StInd_R5_R2_X2:
            *reinterpret_cast<uint16_t*>(r5.usize) = r2.u16; code++; goto Next;
        case OpCode::StInd_R5_R2_X4:
            *reinterpret_cast<uint32_t*>(r5.usize) = r2.u32; code++; goto Next;
        case OpCode::StInd_R5_R2_X8:
            *reinterpret_cast<uint64_t*>(r5.usize) = r2.u64; code++; goto Next;
        case OpCode::StInd_R5_R3_X1:
            *reinterpret_cast<uint8_t*>(r5.usize) = r3.u8; code++; goto Next;
        case OpCode::StInd_R5_R3_X2:
            *reinterpret_cast<uint16_t*>(r5.usize) = r3.u16; code++; goto Next;
        case OpCode::StInd_R5_R3_X4:
            *reinterpret_cast<uint32_t*>(r5.usize) = r3.u32; code++; goto Next;
        case OpCode::StInd_R5_R3_X8:
            *reinterpret_cast<uint64_t*>(r5.usize) = r3.u64; code++; goto Next;
        case OpCode::StInd_R5_R4_X1:
            *reinterpret_cast<uint8_t*>(r5.usize) = r4.u8; code++; goto Next;
        case OpCode::StInd_R5_R4_X2:
            *reinterpret_cast<uint16_t*>(r5.usize) = r4.u16; code++; goto Next;
        case OpCode::StInd_R5_R4_X4:
            *reinterpret_cast<uint32_t*>(r5.usize) = r4.u32; code++; goto Next;
        case OpCode::StInd_R5_R4_X8:
            *reinterpret_cast<uint64_t*>(r5.usize) = r4.u64; code++; goto Next;
        case OpCode::StInd_R5_R5_X1:
            *reinterpret_cast<uint8_t*>(r5.usize) = r5.u8; code++; goto Next;
        case OpCode::StInd_R5_R5_X2:
            *reinterpret_cast<uint16_t*>(r5.usize) = r5.u16; code++; goto Next;
        case OpCode::StInd_R5_R5_X4:
            *reinterpret_cast<uint32_t*>(r5.usize) = r5.u32; code++; goto Next;
        case OpCode::StInd_R5_R5_X8:
            *reinterpret_cast<uint64_t*>(r5.usize) = r5.u64; code++; goto Next;
        case OpCode::StInd_R5_R6_X1:
            *reinterpret_cast<uint8_t*>(r5.usize) = r6.u8; code++; goto Next;
        case OpCode::StInd_R5_R6_X2:
            *reinterpret_cast<uint16_t*>(r5.usize) = r6.u16; code++; goto Next;
        case OpCode::StInd_R5_R6_X4:
            *reinterpret_cast<uint32_t*>(r5.usize) = r6.u32; code++; goto Next;
        case OpCode::StInd_R5_R6_X8:
            *reinterpret_cast<uint64_t*>(r5.usize) = r6.u64; code++; goto Next;
        case OpCode::StInd_R5_R7_X1:
            *reinterpret_cast<uint8_t*>(r5.usize) = r7.u8; code++; goto Next;
        case OpCode::StInd_R5_R7_X2:
            *reinterpret_cast<uint16_t*>(r5.usize) = r7.u16; code++; goto Next;
        case OpCode::StInd_R5_R7_X4:
            *reinterpret_cast<uint32_t*>(r5.usize) = r7.u32; code++; goto Next;
        case OpCode::StInd_R5_R7_X8:
            *reinterpret_cast<uint64_t*>(r5.usize) = r7.u64; code++; goto Next;
        case OpCode::StInd_R6_R0_X1:
            *reinterpret_cast<uint8_t*>(r6.usize) = r0.u8; code++; goto Next;
        case OpCode::StInd_R6_R0_X2:
            *reinterpret_cast<uint16_t*>(r6.usize) = r0.u16; code++; goto Next;
        case OpCode::StInd_R6_R0_X4:
            *reinterpret_cast<uint32_t*>(r6.usize) = r0.u32; code++; goto Next;
        case OpCode::StInd_R6_R0_X8:
            *reinterpret_cast<uint64_t*>(r6.usize) = r0.u64; code++; goto Next;
        case OpCode::StInd_R6_R1_X1:
            *reinterpret_cast<uint8_t*>(r6.usize) = r1.u8; code++; goto Next;
        case OpCode::StInd_R6_R1_X2:
            *reinterpret_cast<uint16_t*>(r6.usize) = r1.u16; code++; goto Next;
        case OpCode::StInd_R6_R1_X4:
            *reinterpret_cast<uint32_t*>(r6.usize) = r1.u32; code++; goto Next;
        case OpCode::StInd_R6_R1_X8:
            *reinterpret_cast<uint64_t*>(r6.usize) = r1.u64; code++; goto Next;
        case OpCode::StInd_R6_R2_X1:
            *reinterpret_cast<uint8_t*>(r6.usize) = r2.u8; code++; goto Next;
        case OpCode::StInd_R6_R2_X2:
            *reinterpret_cast<uint16_t*>(r6.usize) = r2.u16; code++; goto Next;
        case OpCode::StInd_R6_R2_X4:
            *reinterpret_cast<uint32_t*>(r6.usize) = r2.u32; code++; goto Next;
        case OpCode::StInd_R6_R2_X8:
            *reinterpret_cast<uint64_t*>(r6.usize) = r2.u64; code++; goto Next;
        case OpCode::StInd_R6_R3_X1:
            *reinterpret_cast<uint8_t*>(r6.usize) = r3.u8; code++; goto Next;
        case OpCode::StInd_R6_R3_X2:
            *reinterpret_cast<uint16_t*>(r6.usize) = r3.u16; code++; goto Next;
        case OpCode::StInd_R6_R3_X4:
            *reinterpret_cast<uint32_t*>(r6.usize) = r3.u32; code++; goto Next;
        case OpCode::StInd_R6_R3_X8:
            *reinterpret_cast<uint64_t*>(r6.usize) = r3.u64; code++; goto Next;
        case OpCode::StInd_R6_R4_X1:
            *reinterpret_cast<uint8_t*>(r6.usize) = r4.u8; code++; goto Next;
        case OpCode::StInd_R6_R4_X2:
            *reinterpret_cast<uint16_t*>(r6.usize) = r4.u16; code++; goto Next;
        case OpCode::StInd_R6_R4_X4:
            *reinterpret_cast<uint32_t*>(r6.usize) = r4.u32; code++; goto Next;
        case OpCode::StInd_R6_R4_X8:
            *reinterpret_cast<uint64_t*>(r6.usize) = r4.u64; code++; goto Next;
        case OpCode::StInd_R6_R5_X1:
            *reinterpret_cast<uint8_t*>(r6.usize) = r5.u8; code++; goto Next;
        case OpCode::StInd_R6_R5_X2:
            *reinterpret_cast<uint16_t*>(r6.usize) = r5.u16; code++; goto Next;
        case OpCode::StInd_R6_R5_X4:
            *reinterpret_cast<uint32_t*>(r6.usize) = r5.u32; code++; goto Next;
        case OpCode::StInd_R6_R5_X8:
            *reinterpret_cast<uint64_t*>(r6.usize) = r5.u64; code++; goto Next;
        case OpCode::StInd_R6_R6_X1:
            *reinterpret_cast<uint8_t*>(r6.usize) = r6.u8; code++; goto Next;
        case OpCode::StInd_R6_R6_X2:
            *reinterpret_cast<uint16_t*>(r6.usize) = r6.u16; code++; goto Next;
        case OpCode::StInd_R6_R6_X4:
            *reinterpret_cast<uint32_t*>(r6.usize) = r6.u32; code++; goto Next;
        case OpCode::StInd_R6_R6_X8:
            *reinterpret_cast<uint64_t*>(r6.usize) = r6.u64; code++; goto Next;
        case OpCode::StInd_R6_R7_X1:
            *reinterpret_cast<uint8_t*>(r6.usize) = r7.u8; code++; goto Next;
        case OpCode::StInd_R6_R7_X2:
            *reinterpret_cast<uint16_t*>(r6.usize) = r7.u16; code++; goto Next;
        case OpCode::StInd_R6_R7_X4:
            *reinterpret_cast<uint32_t*>(r6.usize) = r7.u32; code++; goto Next;
        case OpCode::StInd_R6_R7_X8:
            *reinterpret_cast<uint64_t*>(r6.usize) = r7.u64; code++; goto Next;
        case OpCode::StInd_R7_R0_X1:
            *reinterpret_cast<uint8_t*>(r7.usize) = r0.u8; code++; goto Next;
        case OpCode::StInd_R7_R0_X2:
            *reinterpret_cast<uint16_t*>(r7.usize) = r0.u16; code++; goto Next;
        case OpCode::StInd_R7_R0_X4:
            *reinterpret_cast<uint32_t*>(r7.usize) = r0.u32; code++; goto Next;
        case OpCode::StInd_R7_R0_X8:
            *reinterpret_cast<uint64_t*>(r7.usize) = r0.u64; code++; goto Next;
        case OpCode::StInd_R7_R1_X1:
            *reinterpret_cast<uint8_t*>(r7.usize) = r1.u8; code++; goto Next;
        case OpCode::StInd_R7_R1_X2:
            *reinterpret_cast<uint16_t*>(r7.usize) = r1.u16; code++; goto Next;
        case OpCode::StInd_R7_R1_X4:
            *reinterpret_cast<uint32_t*>(r7.usize) = r1.u32; code++; goto Next;
        case OpCode::StInd_R7_R1_X8:
            *reinterpret_cast<uint64_t*>(r7.usize) = r1.u64; code++; goto Next;
        case OpCode::StInd_R7_R2_X1:
            *reinterpret_cast<uint8_t*>(r7.usize) = r2.u8; code++; goto Next;
        case OpCode::StInd_R7_R2_X2:
            *reinterpret_cast<uint16_t*>(r7.usize) = r2.u16; code++; goto Next;
        case OpCode::StInd_R7_R2_X4:
            *reinterpret_cast<uint32_t*>(r7.usize) = r2.u32; code++; goto Next;
        case OpCode::StInd_R7_R2_X8:
            *reinterpret_cast<uint64_t*>(r7.usize) = r2.u64; code++; goto Next;
        case OpCode::StInd_R7_R3_X1:
            *reinterpret_cast<uint8_t*>(r7.usize) = r3.u8; code++; goto Next;
        case OpCode::StInd_R7_R3_X2:
            *reinterpret_cast<uint16_t*>(r7.usize) = r3.u16; code++; goto Next;
        case OpCode::StInd_R7_R3_X4:
            *reinterpret_cast<uint32_t*>(r7.usize) = r3.u32; code++; goto Next;
        case OpCode::StInd_R7_R3_X8:
            *reinterpret_cast<uint64_t*>(r7.usize) = r3.u64; code++; goto Next;
        case OpCode::StInd_R7_R4_X1:
            *reinterpret_cast<uint8_t*>(r7.usize) = r4.u8; code++; goto Next;
        case OpCode::StInd_R7_R4_X2:
            *reinterpret_cast<uint16_t*>(r7.usize) = r4.u16; code++; goto Next;
        case OpCode::StInd_R7_R4_X4:
            *reinterpret_cast<uint32_t*>(r7.usize) = r4.u32; code++; goto Next;
        case OpCode::StInd_R7_R4_X8:
            *reinterpret_cast<uint64_t*>(r7.usize) = r4.u64; code++; goto Next;
        case OpCode::StInd_R7_R5_X1:
            *reinterpret_cast<uint8_t*>(r7.usize) = r5.u8; code++; goto Next;
        case OpCode::StInd_R7_R5_X2:
            *reinterpret_cast<uint16_t*>(r7.usize) = r5.u16; code++; goto Next;
        case OpCode::StInd_R7_R5_X4:
            *reinterpret_cast<uint32_t*>(r7.usize) = r5.u32; code++; goto Next;
        case OpCode::StInd_R7_R5_X8:
            *reinterpret_cast<uint64_t*>(r7.usize) = r5.u64; code++; goto Next;
        case OpCode::StInd_R7_R6_X1:
            *reinterpret_cast<uint8_t*>(r7.usize) = r6.u8; code++; goto Next;
        case OpCode::StInd_R7_R6_X2:
            *reinterpret_cast<uint16_t*>(r7.usize) = r6.u16; code++; goto Next;
        case OpCode::StInd_R7_R6_X4:
            *reinterpret_cast<uint32_t*>(r7.usize) = r6.u32; code++; goto Next;
        case OpCode::StInd_R7_R6_X8:
            *reinterpret_cast<uint64_t*>(r7.usize) = r6.u64; code++; goto Next;
        case OpCode::StInd_R7_R7_X1:
            *reinterpret_cast<uint8_t*>(r7.usize) = r7.u8; code++; goto Next;
        case OpCode::StInd_R7_R7_X2:
            *reinterpret_cast<uint16_t*>(r7.usize) = r7.u16; code++; goto Next;
        case OpCode::StInd_R7_R7_X4:
            *reinterpret_cast<uint32_t*>(r7.usize) = r7.u32; code++; goto Next;
        case OpCode::StInd_R7_R7_X8:
            *reinterpret_cast<uint64_t*>(r7.usize) = r7.u64; code++; goto Next;

        case OpCode::Push_R0_X4:
            *reinterpret_cast<uint32_t*>(calc_stack) = r0.u32; calc_stack += 4; code++; goto Next;
        case OpCode::Push_R0_X8:
            *reinterpret_cast<uint64_t*>(calc_stack) = r0.u64; calc_stack += 8; code++; goto Next;
        case OpCode::Push_R1_X4:
            *reinterpret_cast<uint32_t*>(calc_stack) = r1.u32; calc_stack += 4; code++; goto Next;
        case OpCode::Push_R1_X8:
            *reinterpret_cast<uint64_t*>(calc_stack) = r1.u64; calc_stack += 8; code++; goto Next;
        case OpCode::Push_R2_X4:
            *reinterpret_cast<uint32_t*>(calc_stack) = r2.u32; calc_stack += 4; code++; goto Next;
        case OpCode::Push_R2_X8:
            *reinterpret_cast<uint64_t*>(calc_stack) = r2.u64; calc_stack += 8; code++; goto Next;
        case OpCode::Push_R3_X4:
            *reinterpret_cast<uint32_t*>(calc_stack) = r3.u32; calc_stack += 4; code++; goto Next;
        case OpCode::Push_R3_X8:
            *reinterpret_cast<uint64_t*>(calc_stack) = r3.u64; calc_stack += 8; code++; goto Next;
        case OpCode::Push_R4_X4:
            *reinterpret_cast<uint32_t*>(calc_stack) = r4.u32; calc_stack += 4; code++; goto Next;
        case OpCode::Push_R4_X8:
            *reinterpret_cast<uint64_t*>(calc_stack) = r4.u64; calc_stack += 8; code++; goto Next;
        case OpCode::Push_R5_X4:
            *reinterpret_cast<uint32_t*>(calc_stack) = r5.u32; calc_stack += 4; code++; goto Next;
        case OpCode::Push_R5_X8:
            *reinterpret_cast<uint64_t*>(calc_stack) = r5.u64; calc_stack += 8; code++; goto Next;
        case OpCode::Push_R6_X4:
            *reinterpret_cast<uint32_t*>(calc_stack) = r6.u32; calc_stack += 4; code++; goto Next;
        case OpCode::Push_R6_X8:
            *reinterpret_cast<uint64_t*>(calc_stack) = r6.u64; calc_stack += 8; code++; goto Next;
        case OpCode::Push_R7_X4:
            *reinterpret_cast<uint32_t*>(calc_stack) = r7.u32; calc_stack += 4; code++; goto Next;
        case OpCode::Push_R7_X8:
            *reinterpret_cast<uint64_t*>(calc_stack) = r7.u64; calc_stack += 8; code++; goto Next;

        case OpCode::Pop_R0_X1:
            calc_stack -= 4; r0.u8 = *(calc_stack); code++; goto Next;
        case OpCode::Pop_R0_X2:
            calc_stack -= 4; r0.u16 = *reinterpret_cast<uint16_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R0_X4:
            calc_stack -= 4; r0.u32 = *reinterpret_cast<uint32_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R0_X8:
            calc_stack -= 8; r0.u64 = *reinterpret_cast<uint64_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R1_X1:
            calc_stack -= 4; r1.u8 = *(calc_stack); code++; goto Next;
        case OpCode::Pop_R1_X2:
            calc_stack -= 4; r1.u16 = *reinterpret_cast<uint16_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R1_X4:
            calc_stack -= 4; r1.u32 = *reinterpret_cast<uint32_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R1_X8:
            calc_stack -= 8; r1.u64 = *reinterpret_cast<uint64_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R2_X1:
            calc_stack -= 4; r2.u8 = *(calc_stack); code++; goto Next;
        case OpCode::Pop_R2_X2:
            calc_stack -= 4; r2.u16 = *reinterpret_cast<uint16_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R2_X4:
            calc_stack -= 4; r2.u32 = *reinterpret_cast<uint32_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R2_X8:
            calc_stack -= 8; r2.u64 = *reinterpret_cast<uint64_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R3_X1:
            calc_stack -= 4; r3.u8 = *(calc_stack); code++; goto Next;
        case OpCode::Pop_R3_X2:
            calc_stack -= 4; r3.u16 = *reinterpret_cast<uint16_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R3_X4:
            calc_stack -= 4; r3.u32 = *reinterpret_cast<uint32_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R3_X8:
            calc_stack -= 8; r3.u64 = *reinterpret_cast<uint64_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R4_X1:
            calc_stack -= 4; r4.u8 = *(calc_stack); code++; goto Next;
        case OpCode::Pop_R4_X2:
            calc_stack -= 4; r4.u16 = *reinterpret_cast<uint16_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R4_X4:
            calc_stack -= 4; r4.u32 = *reinterpret_cast<uint32_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R4_X8:
            calc_stack -= 8; r4.u64 = *reinterpret_cast<uint64_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R5_X1:
            calc_stack -= 4; r5.u8 = *(calc_stack); code++; goto Next;
        case OpCode::Pop_R5_X2:
            calc_stack -= 4; r5.u16 = *reinterpret_cast<uint16_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R5_X4:
            calc_stack -= 4; r5.u32 = *reinterpret_cast<uint32_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R5_X8:
            calc_stack -= 8; r5.u64 = *reinterpret_cast<uint64_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R6_X1:
            calc_stack -= 4; r6.u8 = *(calc_stack); code++; goto Next;
        case OpCode::Pop_R6_X2:
            calc_stack -= 4; r6.u16 = *reinterpret_cast<uint16_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R6_X4:
            calc_stack -= 4; r6.u32 = *reinterpret_cast<uint32_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R6_X8:
            calc_stack -= 8; r6.u64 = *reinterpret_cast<uint64_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R7_X1:
            calc_stack -= 4; r7.u8 = *(calc_stack); code++; goto Next;
        case OpCode::Pop_R7_X2:
            calc_stack -= 4; r7.u16 = *reinterpret_cast<uint16_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R7_X4:
            calc_stack -= 4; r7.u32 = *reinterpret_cast<uint32_t*>(calc_stack); code++; goto Next;
        case OpCode::Pop_R7_X8:
            calc_stack -= 8; r7.u64 = *reinterpret_cast<uint64_t*>(calc_stack); code++; goto Next;

        case OpCode::Mov_R0_R0_X1:
            r0 = r0.u8; code++; goto Next;
        case OpCode::Mov_R0_R0_X2:
            r0 = r0.u16; code++; goto Next;
        case OpCode::Mov_R0_R0_X4:
            r0 = r0.u32; code++; goto Next;
        case OpCode::Mov_R0_R0_X8:
            r0 = r0.u64; code++; goto Next;
        case OpCode::Mov_R0_R1_X1:
            r0 = r1.u8; code++; goto Next;
        case OpCode::Mov_R0_R1_X2:
            r0 = r1.u16; code++; goto Next;
        case OpCode::Mov_R0_R1_X4:
            r0 = r1.u32; code++; goto Next;
        case OpCode::Mov_R0_R1_X8:
            r0 = r1.u64; code++; goto Next;
        case OpCode::Mov_R0_R2_X1:
            r0 = r2.u8; code++; goto Next;
        case OpCode::Mov_R0_R2_X2:
            r0 = r2.u16; code++; goto Next;
        case OpCode::Mov_R0_R2_X4:
            r0 = r2.u32; code++; goto Next;
        case OpCode::Mov_R0_R2_X8:
            r0 = r2.u64; code++; goto Next;
        case OpCode::Mov_R0_R3_X1:
            r0 = r3.u8; code++; goto Next;
        case OpCode::Mov_R0_R3_X2:
            r0 = r3.u16; code++; goto Next;
        case OpCode::Mov_R0_R3_X4:
            r0 = r3.u32; code++; goto Next;
        case OpCode::Mov_R0_R3_X8:
            r0 = r3.u64; code++; goto Next;
        case OpCode::Mov_R0_R4_X1:
            r0 = r4.u8; code++; goto Next;
        case OpCode::Mov_R0_R4_X2:
            r0 = r4.u16; code++; goto Next;
        case OpCode::Mov_R0_R4_X4:
            r0 = r4.u32; code++; goto Next;
        case OpCode::Mov_R0_R4_X8:
            r0 = r4.u64; code++; goto Next;
        case OpCode::Mov_R0_R5_X1:
            r0 = r5.u8; code++; goto Next;
        case OpCode::Mov_R0_R5_X2:
            r0 = r5.u16; code++; goto Next;
        case OpCode::Mov_R0_R5_X4:
            r0 = r5.u32; code++; goto Next;
        case OpCode::Mov_R0_R5_X8:
            r0 = r5.u64; code++; goto Next;
        case OpCode::Mov_R0_R6_X1:
            r0 = r6.u8; code++; goto Next;
        case OpCode::Mov_R0_R6_X2:
            r0 = r6.u16; code++; goto Next;
        case OpCode::Mov_R0_R6_X4:
            r0 = r6.u32; code++; goto Next;
        case OpCode::Mov_R0_R6_X8:
            r0 = r6.u64; code++; goto Next;
        case OpCode::Mov_R0_R7_X1:
            r0 = r7.u8; code++; goto Next;
        case OpCode::Mov_R0_R7_X2:
            r0 = r7.u16; code++; goto Next;
        case OpCode::Mov_R0_R7_X4:
            r0 = r7.u32; code++; goto Next;
        case OpCode::Mov_R0_R7_X8:
            r0 = r7.u64; code++; goto Next;
        case OpCode::Mov_R1_R0_X1:
            r1 = r0.u8; code++; goto Next;
        case OpCode::Mov_R1_R0_X2:
            r1 = r0.u16; code++; goto Next;
        case OpCode::Mov_R1_R0_X4:
            r1 = r0.u32; code++; goto Next;
        case OpCode::Mov_R1_R0_X8:
            r1 = r0.u64; code++; goto Next;
        case OpCode::Mov_R1_R1_X1:
            r1 = r1.u8; code++; goto Next;
        case OpCode::Mov_R1_R1_X2:
            r1 = r1.u16; code++; goto Next;
        case OpCode::Mov_R1_R1_X4:
            r1 = r1.u32; code++; goto Next;
        case OpCode::Mov_R1_R1_X8:
            r1 = r1.u64; code++; goto Next;
        case OpCode::Mov_R1_R2_X1:
            r1 = r2.u8; code++; goto Next;
        case OpCode::Mov_R1_R2_X2:
            r1 = r2.u16; code++; goto Next;
        case OpCode::Mov_R1_R2_X4:
            r1 = r2.u32; code++; goto Next;
        case OpCode::Mov_R1_R2_X8:
            r1 = r2.u64; code++; goto Next;
        case OpCode::Mov_R1_R3_X1:
            r1 = r3.u8; code++; goto Next;
        case OpCode::Mov_R1_R3_X2:
            r1 = r3.u16; code++; goto Next;
        case OpCode::Mov_R1_R3_X4:
            r1 = r3.u32; code++; goto Next;
        case OpCode::Mov_R1_R3_X8:
            r1 = r3.u64; code++; goto Next;
        case OpCode::Mov_R1_R4_X1:
            r1 = r4.u8; code++; goto Next;
        case OpCode::Mov_R1_R4_X2:
            r1 = r4.u16; code++; goto Next;
        case OpCode::Mov_R1_R4_X4:
            r1 = r4.u32; code++; goto Next;
        case OpCode::Mov_R1_R4_X8:
            r1 = r4.u64; code++; goto Next;
        case OpCode::Mov_R1_R5_X1:
            r1 = r5.u8; code++; goto Next;
        case OpCode::Mov_R1_R5_X2:
            r1 = r5.u16; code++; goto Next;
        case OpCode::Mov_R1_R5_X4:
            r1 = r5.u32; code++; goto Next;
        case OpCode::Mov_R1_R5_X8:
            r1 = r5.u64; code++; goto Next;
        case OpCode::Mov_R1_R6_X1:
            r1 = r6.u8; code++; goto Next;
        case OpCode::Mov_R1_R6_X2:
            r1 = r6.u16; code++; goto Next;
        case OpCode::Mov_R1_R6_X4:
            r1 = r6.u32; code++; goto Next;
        case OpCode::Mov_R1_R6_X8:
            r1 = r6.u64; code++; goto Next;
        case OpCode::Mov_R1_R7_X1:
            r1 = r7.u8; code++; goto Next;
        case OpCode::Mov_R1_R7_X2:
            r1 = r7.u16; code++; goto Next;
        case OpCode::Mov_R1_R7_X4:
            r1 = r7.u32; code++; goto Next;
        case OpCode::Mov_R1_R7_X8:
            r1 = r7.u64; code++; goto Next;
        case OpCode::Mov_R2_R0_X1:
            r2 = r0.u8; code++; goto Next;
        case OpCode::Mov_R2_R0_X2:
            r2 = r0.u16; code++; goto Next;
        case OpCode::Mov_R2_R0_X4:
            r2 = r0.u32; code++; goto Next;
        case OpCode::Mov_R2_R0_X8:
            r2 = r0.u64; code++; goto Next;
        case OpCode::Mov_R2_R1_X1:
            r2 = r1.u8; code++; goto Next;
        case OpCode::Mov_R2_R1_X2:
            r2 = r1.u16; code++; goto Next;
        case OpCode::Mov_R2_R1_X4:
            r2 = r1.u32; code++; goto Next;
        case OpCode::Mov_R2_R1_X8:
            r2 = r1.u64; code++; goto Next;
        case OpCode::Mov_R2_R2_X1:
            r2 = r2.u8; code++; goto Next;
        case OpCode::Mov_R2_R2_X2:
            r2 = r2.u16; code++; goto Next;
        case OpCode::Mov_R2_R2_X4:
            r2 = r2.u32; code++; goto Next;
        case OpCode::Mov_R2_R2_X8:
            r2 = r2.u64; code++; goto Next;
        case OpCode::Mov_R2_R3_X1:
            r2 = r3.u8; code++; goto Next;
        case OpCode::Mov_R2_R3_X2:
            r2 = r3.u16; code++; goto Next;
        case OpCode::Mov_R2_R3_X4:
            r2 = r3.u32; code++; goto Next;
        case OpCode::Mov_R2_R3_X8:
            r2 = r3.u64; code++; goto Next;
        case OpCode::Mov_R2_R4_X1:
            r2 = r4.u8; code++; goto Next;
        case OpCode::Mov_R2_R4_X2:
            r2 = r4.u16; code++; goto Next;
        case OpCode::Mov_R2_R4_X4:
            r2 = r4.u32; code++; goto Next;
        case OpCode::Mov_R2_R4_X8:
            r2 = r4.u64; code++; goto Next;
        case OpCode::Mov_R2_R5_X1:
            r2 = r5.u8; code++; goto Next;
        case OpCode::Mov_R2_R5_X2:
            r2 = r5.u16; code++; goto Next;
        case OpCode::Mov_R2_R5_X4:
            r2 = r5.u32; code++; goto Next;
        case OpCode::Mov_R2_R5_X8:
            r2 = r5.u64; code++; goto Next;
        case OpCode::Mov_R2_R6_X1:
            r2 = r6.u8; code++; goto Next;
        case OpCode::Mov_R2_R6_X2:
            r2 = r6.u16; code++; goto Next;
        case OpCode::Mov_R2_R6_X4:
            r2 = r6.u32; code++; goto Next;
        case OpCode::Mov_R2_R6_X8:
            r2 = r6.u64; code++; goto Next;
        case OpCode::Mov_R2_R7_X1:
            r2 = r7.u8; code++; goto Next;
        case OpCode::Mov_R2_R7_X2:
            r2 = r7.u16; code++; goto Next;
        case OpCode::Mov_R2_R7_X4:
            r2 = r7.u32; code++; goto Next;
        case OpCode::Mov_R2_R7_X8:
            r2 = r7.u64; code++; goto Next;
        case OpCode::Mov_R3_R0_X1:
            r3 = r0.u8; code++; goto Next;
        case OpCode::Mov_R3_R0_X2:
            r3 = r0.u16; code++; goto Next;
        case OpCode::Mov_R3_R0_X4:
            r3 = r0.u32; code++; goto Next;
        case OpCode::Mov_R3_R0_X8:
            r3 = r0.u64; code++; goto Next;
        case OpCode::Mov_R3_R1_X1:
            r3 = r1.u8; code++; goto Next;
        case OpCode::Mov_R3_R1_X2:
            r3 = r1.u16; code++; goto Next;
        case OpCode::Mov_R3_R1_X4:
            r3 = r1.u32; code++; goto Next;
        case OpCode::Mov_R3_R1_X8:
            r3 = r1.u64; code++; goto Next;
        case OpCode::Mov_R3_R2_X1:
            r3 = r2.u8; code++; goto Next;
        case OpCode::Mov_R3_R2_X2:
            r3 = r2.u16; code++; goto Next;
        case OpCode::Mov_R3_R2_X4:
            r3 = r2.u32; code++; goto Next;
        case OpCode::Mov_R3_R2_X8:
            r3 = r2.u64; code++; goto Next;
        case OpCode::Mov_R3_R3_X1:
            r3 = r3.u8; code++; goto Next;
        case OpCode::Mov_R3_R3_X2:
            r3 = r3.u16; code++; goto Next;
        case OpCode::Mov_R3_R3_X4:
            r3 = r3.u32; code++; goto Next;
        case OpCode::Mov_R3_R3_X8:
            r3 = r3.u64; code++; goto Next;
        case OpCode::Mov_R3_R4_X1:
            r3 = r4.u8; code++; goto Next;
        case OpCode::Mov_R3_R4_X2:
            r3 = r4.u16; code++; goto Next;
        case OpCode::Mov_R3_R4_X4:
            r3 = r4.u32; code++; goto Next;
        case OpCode::Mov_R3_R4_X8:
            r3 = r4.u64; code++; goto Next;
        case OpCode::Mov_R3_R5_X1:
            r3 = r5.u8; code++; goto Next;
        case OpCode::Mov_R3_R5_X2:
            r3 = r5.u16; code++; goto Next;
        case OpCode::Mov_R3_R5_X4:
            r3 = r5.u32; code++; goto Next;
        case OpCode::Mov_R3_R5_X8:
            r3 = r5.u64; code++; goto Next;
        case OpCode::Mov_R3_R6_X1:
            r3 = r6.u8; code++; goto Next;
        case OpCode::Mov_R3_R6_X2:
            r3 = r6.u16; code++; goto Next;
        case OpCode::Mov_R3_R6_X4:
            r3 = r6.u32; code++; goto Next;
        case OpCode::Mov_R3_R6_X8:
            r3 = r6.u64; code++; goto Next;
        case OpCode::Mov_R3_R7_X1:
            r3 = r7.u8; code++; goto Next;
        case OpCode::Mov_R3_R7_X2:
            r3 = r7.u16; code++; goto Next;
        case OpCode::Mov_R3_R7_X4:
            r3 = r7.u32; code++; goto Next;
        case OpCode::Mov_R3_R7_X8:
            r3 = r7.u64; code++; goto Next;
        case OpCode::Mov_R4_R0_X1:
            r4 = r0.u8; code++; goto Next;
        case OpCode::Mov_R4_R0_X2:
            r4 = r0.u16; code++; goto Next;
        case OpCode::Mov_R4_R0_X4:
            r4 = r0.u32; code++; goto Next;
        case OpCode::Mov_R4_R0_X8:
            r4 = r0.u64; code++; goto Next;
        case OpCode::Mov_R4_R1_X1:
            r4 = r1.u8; code++; goto Next;
        case OpCode::Mov_R4_R1_X2:
            r4 = r1.u16; code++; goto Next;
        case OpCode::Mov_R4_R1_X4:
            r4 = r1.u32; code++; goto Next;
        case OpCode::Mov_R4_R1_X8:
            r4 = r1.u64; code++; goto Next;
        case OpCode::Mov_R4_R2_X1:
            r4 = r2.u8; code++; goto Next;
        case OpCode::Mov_R4_R2_X2:
            r4 = r2.u16; code++; goto Next;
        case OpCode::Mov_R4_R2_X4:
            r4 = r2.u32; code++; goto Next;
        case OpCode::Mov_R4_R2_X8:
            r4 = r2.u64; code++; goto Next;
        case OpCode::Mov_R4_R3_X1:
            r4 = r3.u8; code++; goto Next;
        case OpCode::Mov_R4_R3_X2:
            r4 = r3.u16; code++; goto Next;
        case OpCode::Mov_R4_R3_X4:
            r4 = r3.u32; code++; goto Next;
        case OpCode::Mov_R4_R3_X8:
            r4 = r3.u64; code++; goto Next;
        case OpCode::Mov_R4_R4_X1:
            r4 = r4.u8; code++; goto Next;
        case OpCode::Mov_R4_R4_X2:
            r4 = r4.u16; code++; goto Next;
        case OpCode::Mov_R4_R4_X4:
            r4 = r4.u32; code++; goto Next;
        case OpCode::Mov_R4_R4_X8:
            r4 = r4.u64; code++; goto Next;
        case OpCode::Mov_R4_R5_X1:
            r4 = r5.u8; code++; goto Next;
        case OpCode::Mov_R4_R5_X2:
            r4 = r5.u16; code++; goto Next;
        case OpCode::Mov_R4_R5_X4:
            r4 = r5.u32; code++; goto Next;
        case OpCode::Mov_R4_R5_X8:
            r4 = r5.u64; code++; goto Next;
        case OpCode::Mov_R4_R6_X1:
            r4 = r6.u8; code++; goto Next;
        case OpCode::Mov_R4_R6_X2:
            r4 = r6.u16; code++; goto Next;
        case OpCode::Mov_R4_R6_X4:
            r4 = r6.u32; code++; goto Next;
        case OpCode::Mov_R4_R6_X8:
            r4 = r6.u64; code++; goto Next;
        case OpCode::Mov_R4_R7_X1:
            r4 = r7.u8; code++; goto Next;
        case OpCode::Mov_R4_R7_X2:
            r4 = r7.u16; code++; goto Next;
        case OpCode::Mov_R4_R7_X4:
            r4 = r7.u32; code++; goto Next;
        case OpCode::Mov_R4_R7_X8:
            r4 = r7.u64; code++; goto Next;
        case OpCode::Mov_R5_R0_X1:
            r5 = r0.u8; code++; goto Next;
        case OpCode::Mov_R5_R0_X2:
            r5 = r0.u16; code++; goto Next;
        case OpCode::Mov_R5_R0_X4:
            r5 = r0.u32; code++; goto Next;
        case OpCode::Mov_R5_R0_X8:
            r5 = r0.u64; code++; goto Next;
        case OpCode::Mov_R5_R1_X1:
            r5 = r1.u8; code++; goto Next;
        case OpCode::Mov_R5_R1_X2:
            r5 = r1.u16; code++; goto Next;
        case OpCode::Mov_R5_R1_X4:
            r5 = r1.u32; code++; goto Next;
        case OpCode::Mov_R5_R1_X8:
            r5 = r1.u64; code++; goto Next;
        case OpCode::Mov_R5_R2_X1:
            r5 = r2.u8; code++; goto Next;
        case OpCode::Mov_R5_R2_X2:
            r5 = r2.u16; code++; goto Next;
        case OpCode::Mov_R5_R2_X4:
            r5 = r2.u32; code++; goto Next;
        case OpCode::Mov_R5_R2_X8:
            r5 = r2.u64; code++; goto Next;
        case OpCode::Mov_R5_R3_X1:
            r5 = r3.u8; code++; goto Next;
        case OpCode::Mov_R5_R3_X2:
            r5 = r3.u16; code++; goto Next;
        case OpCode::Mov_R5_R3_X4:
            r5 = r3.u32; code++; goto Next;
        case OpCode::Mov_R5_R3_X8:
            r5 = r3.u64; code++; goto Next;
        case OpCode::Mov_R5_R4_X1:
            r5 = r4.u8; code++; goto Next;
        case OpCode::Mov_R5_R4_X2:
            r5 = r4.u16; code++; goto Next;
        case OpCode::Mov_R5_R4_X4:
            r5 = r4.u32; code++; goto Next;
        case OpCode::Mov_R5_R4_X8:
            r5 = r4.u64; code++; goto Next;
        case OpCode::Mov_R5_R5_X1:
            r5 = r5.u8; code++; goto Next;
        case OpCode::Mov_R5_R5_X2:
            r5 = r5.u16; code++; goto Next;
        case OpCode::Mov_R5_R5_X4:
            r5 = r5.u32; code++; goto Next;
        case OpCode::Mov_R5_R5_X8:
            r5 = r5.u64; code++; goto Next;
        case OpCode::Mov_R5_R6_X1:
            r5 = r6.u8; code++; goto Next;
        case OpCode::Mov_R5_R6_X2:
            r5 = r6.u16; code++; goto Next;
        case OpCode::Mov_R5_R6_X4:
            r5 = r6.u32; code++; goto Next;
        case OpCode::Mov_R5_R6_X8:
            r5 = r6.u64; code++; goto Next;
        case OpCode::Mov_R5_R7_X1:
            r5 = r7.u8; code++; goto Next;
        case OpCode::Mov_R5_R7_X2:
            r5 = r7.u16; code++; goto Next;
        case OpCode::Mov_R5_R7_X4:
            r5 = r7.u32; code++; goto Next;
        case OpCode::Mov_R5_R7_X8:
            r5 = r7.u64; code++; goto Next;
        case OpCode::Mov_R6_R0_X1:
            r6 = r0.u8; code++; goto Next;
        case OpCode::Mov_R6_R0_X2:
            r6 = r0.u16; code++; goto Next;
        case OpCode::Mov_R6_R0_X4:
            r6 = r0.u32; code++; goto Next;
        case OpCode::Mov_R6_R0_X8:
            r6 = r0.u64; code++; goto Next;
        case OpCode::Mov_R6_R1_X1:
            r6 = r1.u8; code++; goto Next;
        case OpCode::Mov_R6_R1_X2:
            r6 = r1.u16; code++; goto Next;
        case OpCode::Mov_R6_R1_X4:
            r6 = r1.u32; code++; goto Next;
        case OpCode::Mov_R6_R1_X8:
            r6 = r1.u64; code++; goto Next;
        case OpCode::Mov_R6_R2_X1:
            r6 = r2.u8; code++; goto Next;
        case OpCode::Mov_R6_R2_X2:
            r6 = r2.u16; code++; goto Next;
        case OpCode::Mov_R6_R2_X4:
            r6 = r2.u32; code++; goto Next;
        case OpCode::Mov_R6_R2_X8:
            r6 = r2.u64; code++; goto Next;
        case OpCode::Mov_R6_R3_X1:
            r6 = r3.u8; code++; goto Next;
        case OpCode::Mov_R6_R3_X2:
            r6 = r3.u16; code++; goto Next;
        case OpCode::Mov_R6_R3_X4:
            r6 = r3.u32; code++; goto Next;
        case OpCode::Mov_R6_R3_X8:
            r6 = r3.u64; code++; goto Next;
        case OpCode::Mov_R6_R4_X1:
            r6 = r4.u8; code++; goto Next;
        case OpCode::Mov_R6_R4_X2:
            r6 = r4.u16; code++; goto Next;
        case OpCode::Mov_R6_R4_X4:
            r6 = r4.u32; code++; goto Next;
        case OpCode::Mov_R6_R4_X8:
            r6 = r4.u64; code++; goto Next;
        case OpCode::Mov_R6_R5_X1:
            r6 = r5.u8; code++; goto Next;
        case OpCode::Mov_R6_R5_X2:
            r6 = r5.u16; code++; goto Next;
        case OpCode::Mov_R6_R5_X4:
            r6 = r5.u32; code++; goto Next;
        case OpCode::Mov_R6_R5_X8:
            r6 = r5.u64; code++; goto Next;
        case OpCode::Mov_R6_R6_X1:
            r6 = r6.u8; code++; goto Next;
        case OpCode::Mov_R6_R6_X2:
            r6 = r6.u16; code++; goto Next;
        case OpCode::Mov_R6_R6_X4:
            r6 = r6.u32; code++; goto Next;
        case OpCode::Mov_R6_R6_X8:
            r6 = r6.u64; code++; goto Next;
        case OpCode::Mov_R6_R7_X1:
            r6 = r7.u8; code++; goto Next;
        case OpCode::Mov_R6_R7_X2:
            r6 = r7.u16; code++; goto Next;
        case OpCode::Mov_R6_R7_X4:
            r6 = r7.u32; code++; goto Next;
        case OpCode::Mov_R6_R7_X8:
            r6 = r7.u64; code++; goto Next;
        case OpCode::Mov_R7_R0_X1:
            r7 = r0.u8; code++; goto Next;
        case OpCode::Mov_R7_R0_X2:
            r7 = r0.u16; code++; goto Next;
        case OpCode::Mov_R7_R0_X4:
            r7 = r0.u32; code++; goto Next;
        case OpCode::Mov_R7_R0_X8:
            r7 = r0.u64; code++; goto Next;
        case OpCode::Mov_R7_R1_X1:
            r7 = r1.u8; code++; goto Next;
        case OpCode::Mov_R7_R1_X2:
            r7 = r1.u16; code++; goto Next;
        case OpCode::Mov_R7_R1_X4:
            r7 = r1.u32; code++; goto Next;
        case OpCode::Mov_R7_R1_X8:
            r7 = r1.u64; code++; goto Next;
        case OpCode::Mov_R7_R2_X1:
            r7 = r2.u8; code++; goto Next;
        case OpCode::Mov_R7_R2_X2:
            r7 = r2.u16; code++; goto Next;
        case OpCode::Mov_R7_R2_X4:
            r7 = r2.u32; code++; goto Next;
        case OpCode::Mov_R7_R2_X8:
            r7 = r2.u64; code++; goto Next;
        case OpCode::Mov_R7_R3_X1:
            r7 = r3.u8; code++; goto Next;
        case OpCode::Mov_R7_R3_X2:
            r7 = r3.u16; code++; goto Next;
        case OpCode::Mov_R7_R3_X4:
            r7 = r3.u32; code++; goto Next;
        case OpCode::Mov_R7_R3_X8:
            r7 = r3.u64; code++; goto Next;
        case OpCode::Mov_R7_R4_X1:
            r7 = r4.u8; code++; goto Next;
        case OpCode::Mov_R7_R4_X2:
            r7 = r4.u16; code++; goto Next;
        case OpCode::Mov_R7_R4_X4:
            r7 = r4.u32; code++; goto Next;
        case OpCode::Mov_R7_R4_X8:
            r7 = r4.u64; code++; goto Next;
        case OpCode::Mov_R7_R5_X1:
            r7 = r5.u8; code++; goto Next;
        case OpCode::Mov_R7_R5_X2:
            r7 = r5.u16; code++; goto Next;
        case OpCode::Mov_R7_R5_X4:
            r7 = r5.u32; code++; goto Next;
        case OpCode::Mov_R7_R5_X8:
            r7 = r5.u64; code++; goto Next;
        case OpCode::Mov_R7_R6_X1:
            r7 = r6.u8; code++; goto Next;
        case OpCode::Mov_R7_R6_X2:
            r7 = r6.u16; code++; goto Next;
        case OpCode::Mov_R7_R6_X4:
            r7 = r6.u32; code++; goto Next;
        case OpCode::Mov_R7_R6_X8:
            r7 = r6.u64; code++; goto Next;
        case OpCode::Mov_R7_R7_X1:
            r7 = r7.u8; code++; goto Next;
        case OpCode::Mov_R7_R7_X2:
            r7 = r7.u16; code++; goto Next;
        case OpCode::Mov_R7_R7_X4:
            r7 = r7.u32; code++; goto Next;
        case OpCode::Mov_R7_R7_X8:
            r7 = r7.u64; code++; goto Next;

        case OpCode::AddI_R0_R0_X1:
            r0 = static_cast<int8_t>(r0.i8 + r0.i8); code++; goto Next;
        case OpCode::AddI_R0_R1_X1:
            r0 = static_cast<int8_t>(r0.i8 + r1.i8); code++; goto Next;
        case OpCode::AddI_R0_R2_X1:
            r0 = static_cast<int8_t>(r0.i8 + r2.i8); code++; goto Next;
        case OpCode::AddI_R0_R3_X1:
            r0 = static_cast<int8_t>(r0.i8 + r3.i8); code++; goto Next;
        case OpCode::AddI_R0_R4_X1:
            r0 = static_cast<int8_t>(r0.i8 + r4.i8); code++; goto Next;
        case OpCode::AddI_R0_R5_X1:
            r0 = static_cast<int8_t>(r0.i8 + r5.i8); code++; goto Next;
        case OpCode::AddI_R0_R6_X1:
            r0 = static_cast<int8_t>(r0.i8 + r6.i8); code++; goto Next;
        case OpCode::AddI_R0_R7_X1:
            r0 = static_cast<int8_t>(r0.i8 + r7.i8); code++; goto Next;
        case OpCode::AddI_R1_R0_X1:
            r1 = static_cast<int8_t>(r1.i8 + r0.i8); code++; goto Next;
        case OpCode::AddI_R1_R1_X1:
            r1 = static_cast<int8_t>(r1.i8 + r1.i8); code++; goto Next;
        case OpCode::AddI_R1_R2_X1:
            r1 = static_cast<int8_t>(r1.i8 + r2.i8); code++; goto Next;
        case OpCode::AddI_R1_R3_X1:
            r1 = static_cast<int8_t>(r1.i8 + r3.i8); code++; goto Next;
        case OpCode::AddI_R1_R4_X1:
            r1 = static_cast<int8_t>(r1.i8 + r4.i8); code++; goto Next;
        case OpCode::AddI_R1_R5_X1:
            r1 = static_cast<int8_t>(r1.i8 + r5.i8); code++; goto Next;
        case OpCode::AddI_R1_R6_X1:
            r1 = static_cast<int8_t>(r1.i8 + r6.i8); code++; goto Next;
        case OpCode::AddI_R1_R7_X1:
            r1 = static_cast<int8_t>(r1.i8 + r7.i8); code++; goto Next;
        case OpCode::AddI_R2_R0_X1:
            r2 = static_cast<int8_t>(r2.i8 + r0.i8); code++; goto Next;
        case OpCode::AddI_R2_R1_X1:
            r2 = static_cast<int8_t>(r2.i8 + r1.i8); code++; goto Next;
        case OpCode::AddI_R2_R2_X1:
            r2 = static_cast<int8_t>(r2.i8 + r2.i8); code++; goto Next;
        case OpCode::AddI_R2_R3_X1:
            r2 = static_cast<int8_t>(r2.i8 + r3.i8); code++; goto Next;
        case OpCode::AddI_R2_R4_X1:
            r2 = static_cast<int8_t>(r2.i8 + r4.i8); code++; goto Next;
        case OpCode::AddI_R2_R5_X1:
            r2 = static_cast<int8_t>(r2.i8 + r5.i8); code++; goto Next;
        case OpCode::AddI_R2_R6_X1:
            r2 = static_cast<int8_t>(r2.i8 + r6.i8); code++; goto Next;
        case OpCode::AddI_R2_R7_X1:
            r2 = static_cast<int8_t>(r2.i8 + r7.i8); code++; goto Next;
        case OpCode::AddI_R3_R0_X1:
            r3 = static_cast<int8_t>(r3.i8 + r0.i8); code++; goto Next;
        case OpCode::AddI_R3_R1_X1:
            r3 = static_cast<int8_t>(r3.i8 + r1.i8); code++; goto Next;
        case OpCode::AddI_R3_R2_X1:
            r3 = static_cast<int8_t>(r3.i8 + r2.i8); code++; goto Next;
        case OpCode::AddI_R3_R3_X1:
            r3 = static_cast<int8_t>(r3.i8 + r3.i8); code++; goto Next;
        case OpCode::AddI_R3_R4_X1:
            r3 = static_cast<int8_t>(r3.i8 + r4.i8); code++; goto Next;
        case OpCode::AddI_R3_R5_X1:
            r3 = static_cast<int8_t>(r3.i8 + r5.i8); code++; goto Next;
        case OpCode::AddI_R3_R6_X1:
            r3 = static_cast<int8_t>(r3.i8 + r6.i8); code++; goto Next;
        case OpCode::AddI_R3_R7_X1:
            r3 = static_cast<int8_t>(r3.i8 + r7.i8); code++; goto Next;
        case OpCode::AddI_R4_R0_X1:
            r4 = static_cast<int8_t>(r4.i8 + r0.i8); code++; goto Next;
        case OpCode::AddI_R4_R1_X1:
            r4 = static_cast<int8_t>(r4.i8 + r1.i8); code++; goto Next;
        case OpCode::AddI_R4_R2_X1:
            r4 = static_cast<int8_t>(r4.i8 + r2.i8); code++; goto Next;
        case OpCode::AddI_R4_R3_X1:
            r4 = static_cast<int8_t>(r4.i8 + r3.i8); code++; goto Next;
        case OpCode::AddI_R4_R4_X1:
            r4 = static_cast<int8_t>(r4.i8 + r4.i8); code++; goto Next;
        case OpCode::AddI_R4_R5_X1:
            r4 = static_cast<int8_t>(r4.i8 + r5.i8); code++; goto Next;
        case OpCode::AddI_R4_R6_X1:
            r4 = static_cast<int8_t>(r4.i8 + r6.i8); code++; goto Next;
        case OpCode::AddI_R4_R7_X1:
            r4 = static_cast<int8_t>(r4.i8 + r7.i8); code++; goto Next;
        case OpCode::AddI_R5_R0_X1:
            r5 = static_cast<int8_t>(r5.i8 + r0.i8); code++; goto Next;
        case OpCode::AddI_R5_R1_X1:
            r5 = static_cast<int8_t>(r5.i8 + r1.i8); code++; goto Next;
        case OpCode::AddI_R5_R2_X1:
            r5 = static_cast<int8_t>(r5.i8 + r2.i8); code++; goto Next;
        case OpCode::AddI_R5_R3_X1:
            r5 = static_cast<int8_t>(r5.i8 + r3.i8); code++; goto Next;
        case OpCode::AddI_R5_R4_X1:
            r5 = static_cast<int8_t>(r5.i8 + r4.i8); code++; goto Next;
        case OpCode::AddI_R5_R5_X1:
            r5 = static_cast<int8_t>(r5.i8 + r5.i8); code++; goto Next;
        case OpCode::AddI_R5_R6_X1:
            r5 = static_cast<int8_t>(r5.i8 + r6.i8); code++; goto Next;
        case OpCode::AddI_R5_R7_X1:
            r5 = static_cast<int8_t>(r5.i8 + r7.i8); code++; goto Next;
        case OpCode::AddI_R6_R0_X1:
            r6 = static_cast<int8_t>(r6.i8 + r0.i8); code++; goto Next;
        case OpCode::AddI_R6_R1_X1:
            r6 = static_cast<int8_t>(r6.i8 + r1.i8); code++; goto Next;
        case OpCode::AddI_R6_R2_X1:
            r6 = static_cast<int8_t>(r6.i8 + r2.i8); code++; goto Next;
        case OpCode::AddI_R6_R3_X1:
            r6 = static_cast<int8_t>(r6.i8 + r3.i8); code++; goto Next;
        case OpCode::AddI_R6_R4_X1:
            r6 = static_cast<int8_t>(r6.i8 + r4.i8); code++; goto Next;
        case OpCode::AddI_R6_R5_X1:
            r6 = static_cast<int8_t>(r6.i8 + r5.i8); code++; goto Next;
        case OpCode::AddI_R6_R6_X1:
            r6 = static_cast<int8_t>(r6.i8 + r6.i8); code++; goto Next;
        case OpCode::AddI_R6_R7_X1:
            r6 = static_cast<int8_t>(r6.i8 + r7.i8); code++; goto Next;
        case OpCode::AddI_R7_R0_X1:
            r7 = static_cast<int8_t>(r7.i8 + r0.i8); code++; goto Next;
        case OpCode::AddI_R7_R1_X1:
            r7 = static_cast<int8_t>(r7.i8 + r1.i8); code++; goto Next;
        case OpCode::AddI_R7_R2_X1:
            r7 = static_cast<int8_t>(r7.i8 + r2.i8); code++; goto Next;
        case OpCode::AddI_R7_R3_X1:
            r7 = static_cast<int8_t>(r7.i8 + r3.i8); code++; goto Next;
        case OpCode::AddI_R7_R4_X1:
            r7 = static_cast<int8_t>(r7.i8 + r4.i8); code++; goto Next;
        case OpCode::AddI_R7_R5_X1:
            r7 = static_cast<int8_t>(r7.i8 + r5.i8); code++; goto Next;
        case OpCode::AddI_R7_R6_X1:
            r7 = static_cast<int8_t>(r7.i8 + r6.i8); code++; goto Next;
        case OpCode::AddI_R7_R7_X1:
            r7 = static_cast<int8_t>(r7.i8 + r7.i8); code++; goto Next;
        ...
        case OpCode::AddI_R0_R0_X2:
            r0 = static_cast<int16_t>(r0.i16 + r0.i16); code++; goto Next;
        case OpCode::AddI_R0_R1_X2:
            r0 = static_cast<int16_t>(r0.i16 + r1.i16); code++; goto Next;
        case OpCode::AddI_R0_R2_X2:
            r0 = static_cast<int16_t>(r0.i16 + r2.i16); code++; goto Next;
        case OpCode::AddI_R0_R3_X2:
            r0 = static_cast<int16_t>(r0.i16 + r3.i16); code++; goto Next;
        case OpCode::AddI_R0_R4_X2:
            r0 = static_cast<int16_t>(r0.i16 + r4.i16); code++; goto Next;
        case OpCode::AddI_R0_R5_X2:
            r0 = static_cast<int16_t>(r0.i16 + r5.i16); code++; goto Next;
        case OpCode::AddI_R0_R6_X2:
            r0 = static_cast<int16_t>(r0.i16 + r6.i16); code++; goto Next;
        case OpCode::AddI_R0_R7_X2:
            r0 = static_cast<int16_t>(r0.i16 + r7.i16); code++; goto Next;
        case OpCode::AddI_R1_R0_X2:
            r1 = static_cast<int16_t>(r1.i16 + r0.i16); code++; goto Next;
        case OpCode::AddI_R1_R1_X2:
            r1 = static_cast<int16_t>(r1.i16 + r1.i16); code++; goto Next;
        case OpCode::AddI_R1_R2_X2:
            r1 = static_cast<int16_t>(r1.i16 + r2.i16); code++; goto Next;
        case OpCode::AddI_R1_R3_X2:
            r1 = static_cast<int16_t>(r1.i16 + r3.i16); code++; goto Next;
        case OpCode::AddI_R1_R4_X2:
            r1 = static_cast<int16_t>(r1.i16 + r4.i16); code++; goto Next;
        case OpCode::AddI_R1_R5_X2:
            r1 = static_cast<int16_t>(r1.i16 + r5.i16); code++; goto Next;
        case OpCode::AddI_R1_R6_X2:
            r1 = static_cast<int16_t>(r1.i16 + r6.i16); code++; goto Next;
        case OpCode::AddI_R1_R7_X2:
            r1 = static_cast<int16_t>(r1.i16 + r7.i16); code++; goto Next;
        case OpCode::AddI_R2_R0_X2:
            r2 = static_cast<int16_t>(r2.i16 + r0.i16); code++; goto Next;
        case OpCode::AddI_R2_R1_X2:
            r2 = static_cast<int16_t>(r2.i16 + r1.i16); code++; goto Next;
        case OpCode::AddI_R2_R2_X2:
            r2 = static_cast<int16_t>(r2.i16 + r2.i16); code++; goto Next;
        case OpCode::AddI_R2_R3_X2:
            r2 = static_cast<int16_t>(r2.i16 + r3.i16); code++; goto Next;
        case OpCode::AddI_R2_R4_X2:
            r2 = static_cast<int16_t>(r2.i16 + r4.i16); code++; goto Next;
        case OpCode::AddI_R2_R5_X2:
            r2 = static_cast<int16_t>(r2.i16 + r5.i16); code++; goto Next;
        case OpCode::AddI_R2_R6_X2:
            r2 = static_cast<int16_t>(r2.i16 + r6.i16); code++; goto Next;
        case OpCode::AddI_R2_R7_X2:
            r2 = static_cast<int16_t>(r2.i16 + r7.i16); code++; goto Next;
        case OpCode::AddI_R3_R0_X2:
            r3 = static_cast<int16_t>(r3.i16 + r0.i16); code++; goto Next;
        case OpCode::AddI_R3_R1_X2:
            r3 = static_cast<int16_t>(r3.i16 + r1.i16); code++; goto Next;
        case OpCode::AddI_R3_R2_X2:
            r3 = static_cast<int16_t>(r3.i16 + r2.i16); code++; goto Next;
        case OpCode::AddI_R3_R3_X2:
            r3 = static_cast<int16_t>(r3.i16 + r3.i16); code++; goto Next;
        case OpCode::AddI_R3_R4_X2:
            r3 = static_cast<int16_t>(r3.i16 + r4.i16); code++; goto Next;
        case OpCode::AddI_R3_R5_X2:
            r3 = static_cast<int16_t>(r3.i16 + r5.i16); code++; goto Next;
        case OpCode::AddI_R3_R6_X2:
            r3 = static_cast<int16_t>(r3.i16 + r6.i16); code++; goto Next;
        case OpCode::AddI_R3_R7_X2:
            r3 = static_cast<int16_t>(r3.i16 + r7.i16); code++; goto Next;
        case OpCode::AddI_R4_R0_X2:
            r4 = static_cast<int16_t>(r4.i16 + r0.i16); code++; goto Next;
        case OpCode::AddI_R4_R1_X2:
            r4 = static_cast<int16_t>(r4.i16 + r1.i16); code++; goto Next;
        case OpCode::AddI_R4_R2_X2:
            r4 = static_cast<int16_t>(r4.i16 + r2.i16); code++; goto Next;
        case OpCode::AddI_R4_R3_X2:
            r4 = static_cast<int16_t>(r4.i16 + r3.i16); code++; goto Next;
        case OpCode::AddI_R4_R4_X2:
            r4 = static_cast<int16_t>(r4.i16 + r4.i16); code++; goto Next;
        case OpCode::AddI_R4_R5_X2:
            r4 = static_cast<int16_t>(r4.i16 + r5.i16); code++; goto Next;
        case OpCode::AddI_R4_R6_X2:
            r4 = static_cast<int16_t>(r4.i16 + r6.i16); code++; goto Next;
        case OpCode::AddI_R4_R7_X2:
            r4 = static_cast<int16_t>(r4.i16 + r7.i16); code++; goto Next;
        case OpCode::AddI_R5_R0_X2:
            r5 = static_cast<int16_t>(r5.i16 + r0.i16); code++; goto Next;
        case OpCode::AddI_R5_R1_X2:
            r5 = static_cast<int16_t>(r5.i16 + r1.i16); code++; goto Next;
        case OpCode::AddI_R5_R2_X2:
            r5 = static_cast<int16_t>(r5.i16 + r2.i16); code++; goto Next;
        case OpCode::AddI_R5_R3_X2:
            r5 = static_cast<int16_t>(r5.i16 + r3.i16); code++; goto Next;
        case OpCode::AddI_R5_R4_X2:
            r5 = static_cast<int16_t>(r5.i16 + r4.i16); code++; goto Next;
        case OpCode::AddI_R5_R5_X2:
            r5 = static_cast<int16_t>(r5.i16 + r5.i16); code++; goto Next;
        case OpCode::AddI_R5_R6_X2:
            r5 = static_cast<int16_t>(r5.i16 + r6.i16); code++; goto Next;
        case OpCode::AddI_R5_R7_X2:
            r5 = static_cast<int16_t>(r5.i16 + r7.i16); code++; goto Next;
        case OpCode::AddI_R6_R0_X2:
            r6 = static_cast<int16_t>(r6.i16 + r0.i16); code++; goto Next;
        case OpCode::AddI_R6_R1_X2:
            r6 = static_cast<int16_t>(r6.i16 + r1.i16); code++; goto Next;
        case OpCode::AddI_R6_R2_X2:
            r6 = static_cast<int16_t>(r6.i16 + r2.i16); code++; goto Next;
        case OpCode::AddI_R6_R3_X2:
            r6 = static_cast<int16_t>(r6.i16 + r3.i16); code++; goto Next;
        case OpCode::AddI_R6_R4_X2:
            r6 = static_cast<int16_t>(r6.i16 + r4.i16); code++; goto Next;
        case OpCode::AddI_R6_R5_X2:
            r6 = static_cast<int16_t>(r6.i16 + r5.i16); code++; goto Next;
        case OpCode::AddI_R6_R6_X2:
            r6 = static_cast<int16_t>(r6.i16 + r6.i16); code++; goto Next;
        case OpCode::AddI_R6_R7_X2:
            r6 = static_cast<int16_t>(r6.i16 + r7.i16); code++; goto Next;
        case OpCode::AddI_R7_R0_X2:
            r7 = static_cast<int16_t>(r7.i16 + r0.i16); code++; goto Next;
        case OpCode::AddI_R7_R1_X2:
            r7 = static_cast<int16_t>(r7.i16 + r1.i16); code++; goto Next;
        case OpCode::AddI_R7_R2_X2:
            r7 = static_cast<int16_t>(r7.i16 + r2.i16); code++; goto Next;
        case OpCode::AddI_R7_R3_X2:
            r7 = static_cast<int16_t>(r7.i16 + r3.i16); code++; goto Next;
        case OpCode::AddI_R7_R4_X2:
            r7 = static_cast<int16_t>(r7.i16 + r4.i16); code++; goto Next;
        case OpCode::AddI_R7_R5_X2:
            r7 = static_cast<int16_t>(r7.i16 + r5.i16); code++; goto Next;
        case OpCode::AddI_R7_R6_X2:
            r7 = static_cast<int16_t>(r7.i16 + r6.i16); code++; goto Next;
        case OpCode::AddI_R7_R7_X2:
            r7 = static_cast<int16_t>(r7.i16 + r7.i16); code++; goto Next;
        ...
        case OpCode::AddI_R0_R0_X4:
            r0 = static_cast<int32_t>(r0.i32 + r0.i32); code++; goto Next;
        case OpCode::AddI_R0_R1_X4:
            r0 = static_cast<int32_t>(r0.i32 + r1.i32); code++; goto Next;
        case OpCode::AddI_R0_R2_X4:
            r0 = static_cast<int32_t>(r0.i32 + r2.i32); code++; goto Next;
        case OpCode::AddI_R0_R3_X4:
            r0 = static_cast<int32_t>(r0.i32 + r3.i32); code++; goto Next;
        case OpCode::AddI_R0_R4_X4:
            r0 = static_cast<int32_t>(r0.i32 + r4.i32); code++; goto Next;
        case OpCode::AddI_R0_R5_X4:
            r0 = static_cast<int32_t>(r0.i32 + r5.i32); code++; goto Next;
        case OpCode::AddI_R0_R6_X4:
            r0 = static_cast<int32_t>(r0.i32 + r6.i32); code++; goto Next;
        case OpCode::AddI_R0_R7_X4:
            r0 = static_cast<int32_t>(r0.i32 + r7.i32); code++; goto Next;
        case OpCode::AddI_R1_R0_X4:
            r1 = static_cast<int32_t>(r1.i32 + r0.i32); code++; goto Next;
        case OpCode::AddI_R1_R1_X4:
            r1 = static_cast<int32_t>(r1.i32 + r1.i32); code++; goto Next;
        case OpCode::AddI_R1_R2_X4:
            r1 = static_cast<int32_t>(r1.i32 + r2.i32); code++; goto Next;
        case OpCode::AddI_R1_R3_X4:
            r1 = static_cast<int32_t>(r1.i32 + r3.i32); code++; goto Next;
        case OpCode::AddI_R1_R4_X4:
            r1 = static_cast<int32_t>(r1.i32 + r4.i32); code++; goto Next;
        case OpCode::AddI_R1_R5_X4:
            r1 = static_cast<int32_t>(r1.i32 + r5.i32); code++; goto Next;
        case OpCode::AddI_R1_R6_X4:
            r1 = static_cast<int32_t>(r1.i32 + r6.i32); code++; goto Next;
        case OpCode::AddI_R1_R7_X4:
            r1 = static_cast<int32_t>(r1.i32 + r7.i32); code++; goto Next;
        case OpCode::AddI_R2_R0_X4:
            r2 = static_cast<int32_t>(r2.i32 + r0.i32); code++; goto Next;
        case OpCode::AddI_R2_R1_X4:
            r2 = static_cast<int32_t>(r2.i32 + r1.i32); code++; goto Next;
        case OpCode::AddI_R2_R2_X4:
            r2 = static_cast<int32_t>(r2.i32 + r2.i32); code++; goto Next;
        case OpCode::AddI_R2_R3_X4:
            r2 = static_cast<int32_t>(r2.i32 + r3.i32); code++; goto Next;
        case OpCode::AddI_R2_R4_X4:
            r2 = static_cast<int32_t>(r2.i32 + r4.i32); code++; goto Next;
        case OpCode::AddI_R2_R5_X4:
            r2 = static_cast<int32_t>(r2.i32 + r5.i32); code++; goto Next;
        case OpCode::AddI_R2_R6_X4:
            r2 = static_cast<int32_t>(r2.i32 + r6.i32); code++; goto Next;
        case OpCode::AddI_R2_R7_X4:
            r2 = static_cast<int32_t>(r2.i32 + r7.i32); code++; goto Next;
        case OpCode::AddI_R3_R0_X4:
            r3 = static_cast<int32_t>(r3.i32 + r0.i32); code++; goto Next;
        case OpCode::AddI_R3_R1_X4:
            r3 = static_cast<int32_t>(r3.i32 + r1.i32); code++; goto Next;
        case OpCode::AddI_R3_R2_X4:
            r3 = static_cast<int32_t>(r3.i32 + r2.i32); code++; goto Next;
        case OpCode::AddI_R3_R3_X4:
            r3 = static_cast<int32_t>(r3.i32 + r3.i32); code++; goto Next;
        case OpCode::AddI_R3_R4_X4:
            r3 = static_cast<int32_t>(r3.i32 + r4.i32); code++; goto Next;
        case OpCode::AddI_R3_R5_X4:
            r3 = static_cast<int32_t>(r3.i32 + r5.i32); code++; goto Next;
        case OpCode::AddI_R3_R6_X4:
            r3 = static_cast<int32_t>(r3.i32 + r6.i32); code++; goto Next;
        case OpCode::AddI_R3_R7_X4:
            r3 = static_cast<int32_t>(r3.i32 + r7.i32); code++; goto Next;
        case OpCode::AddI_R4_R0_X4:
            r4 = static_cast<int32_t>(r4.i32 + r0.i32); code++; goto Next;
        case OpCode::AddI_R4_R1_X4:
            r4 = static_cast<int32_t>(r4.i32 + r1.i32); code++; goto Next;
        case OpCode::AddI_R4_R2_X4:
            r4 = static_cast<int32_t>(r4.i32 + r2.i32); code++; goto Next;
        case OpCode::AddI_R4_R3_X4:
            r4 = static_cast<int32_t>(r4.i32 + r3.i32); code++; goto Next;
        case OpCode::AddI_R4_R4_X4:
            r4 = static_cast<int32_t>(r4.i32 + r4.i32); code++; goto Next;
        case OpCode::AddI_R4_R5_X4:
            r4 = static_cast<int32_t>(r4.i32 + r5.i32); code++; goto Next;
        case OpCode::AddI_R4_R6_X4:
            r4 = static_cast<int32_t>(r4.i32 + r6.i32); code++; goto Next;
        case OpCode::AddI_R4_R7_X4:
            r4 = static_cast<int32_t>(r4.i32 + r7.i32); code++; goto Next;
        case OpCode::AddI_R5_R0_X4:
            r5 = static_cast<int32_t>(r5.i32 + r0.i32); code++; goto Next;
        case OpCode::AddI_R5_R1_X4:
            r5 = static_cast<int32_t>(r5.i32 + r1.i32); code++; goto Next;
        case OpCode::AddI_R5_R2_X4:
            r5 = static_cast<int32_t>(r5.i32 + r2.i32); code++; goto Next;
        case OpCode::AddI_R5_R3_X4:
            r5 = static_cast<int32_t>(r5.i32 + r3.i32); code++; goto Next;
        case OpCode::AddI_R5_R4_X4:
            r5 = static_cast<int32_t>(r5.i32 + r4.i32); code++; goto Next;
        case OpCode::AddI_R5_R5_X4:
            r5 = static_cast<int32_t>(r5.i32 + r5.i32); code++; goto Next;
        case OpCode::AddI_R5_R6_X4:
            r5 = static_cast<int32_t>(r5.i32 + r6.i32); code++; goto Next;
        case OpCode::AddI_R5_R7_X4:
            r5 = static_cast<int32_t>(r5.i32 + r7.i32); code++; goto Next;
        case OpCode::AddI_R6_R0_X4:
            r6 = static_cast<int32_t>(r6.i32 + r0.i32); code++; goto Next;
        case OpCode::AddI_R6_R1_X4:
            r6 = static_cast<int32_t>(r6.i32 + r1.i32); code++; goto Next;
        case OpCode::AddI_R6_R2_X4:
            r6 = static_cast<int32_t>(r6.i32 + r2.i32); code++; goto Next;
        case OpCode::AddI_R6_R3_X4:
            r6 = static_cast<int32_t>(r6.i32 + r3.i32); code++; goto Next;
        case OpCode::AddI_R6_R4_X4:
            r6 = static_cast<int32_t>(r6.i32 + r4.i32); code++; goto Next;
        case OpCode::AddI_R6_R5_X4:
            r6 = static_cast<int32_t>(r6.i32 + r5.i32); code++; goto Next;
        case OpCode::AddI_R6_R6_X4:
            r6 = static_cast<int32_t>(r6.i32 + r6.i32); code++; goto Next;
        case OpCode::AddI_R6_R7_X4:
            r6 = static_cast<int32_t>(r6.i32 + r7.i32); code++; goto Next;
        case OpCode::AddI_R7_R0_X4:
            r7 = static_cast<int32_t>(r7.i32 + r0.i32); code++; goto Next;
        case OpCode::AddI_R7_R1_X4:
            r7 = static_cast<int32_t>(r7.i32 + r1.i32); code++; goto Next;
        case OpCode::AddI_R7_R2_X4:
            r7 = static_cast<int32_t>(r7.i32 + r2.i32); code++; goto Next;
        case OpCode::AddI_R7_R3_X4:
            r7 = static_cast<int32_t>(r7.i32 + r3.i32); code++; goto Next;
        case OpCode::AddI_R7_R4_X4:
            r7 = static_cast<int32_t>(r7.i32 + r4.i32); code++; goto Next;
        case OpCode::AddI_R7_R5_X4:
            r7 = static_cast<int32_t>(r7.i32 + r5.i32); code++; goto Next;
        case OpCode::AddI_R7_R6_X4:
            r7 = static_cast<int32_t>(r7.i32 + r6.i32); code++; goto Next;
        case OpCode::AddI_R7_R7_X4:
            r7 = static_cast<int32_t>(r7.i32 + r7.i32); code++; goto Next;
        ...
        case OpCode::AddI_R0_R0_X8:
            r0 = static_cast<int64_t>(r0.i64 + r0.i64); code++; goto Next;
        case OpCode::AddI_R0_R1_X8:
            r0 = static_cast<int64_t>(r0.i64 + r1.i64); code++; goto Next;
        case OpCode::AddI_R0_R2_X8:
            r0 = static_cast<int64_t>(r0.i64 + r2.i64); code++; goto Next;
        case OpCode::AddI_R0_R3_X8:
            r0 = static_cast<int64_t>(r0.i64 + r3.i64); code++; goto Next;
        case OpCode::AddI_R0_R4_X8:
            r0 = static_cast<int64_t>(r0.i64 + r4.i64); code++; goto Next;
        case OpCode::AddI_R0_R5_X8:
            r0 = static_cast<int64_t>(r0.i64 + r5.i64); code++; goto Next;
        case OpCode::AddI_R0_R6_X8:
            r0 = static_cast<int64_t>(r0.i64 + r6.i64); code++; goto Next;
        case OpCode::AddI_R0_R7_X8:
            r0 = static_cast<int64_t>(r0.i64 + r7.i64); code++; goto Next;
        case OpCode::AddI_R1_R0_X8:
            r1 = static_cast<int64_t>(r1.i64 + r0.i64); code++; goto Next;
        case OpCode::AddI_R1_R1_X8:
            r1 = static_cast<int64_t>(r1.i64 + r1.i64); code++; goto Next;
        case OpCode::AddI_R1_R2_X8:
            r1 = static_cast<int64_t>(r1.i64 + r2.i64); code++; goto Next;
        case OpCode::AddI_R1_R3_X8:
            r1 = static_cast<int64_t>(r1.i64 + r3.i64); code++; goto Next;
        case OpCode::AddI_R1_R4_X8:
            r1 = static_cast<int64_t>(r1.i64 + r4.i64); code++; goto Next;
        case OpCode::AddI_R1_R5_X8:
            r1 = static_cast<int64_t>(r1.i64 + r5.i64); code++; goto Next;
        case OpCode::AddI_R1_R6_X8:
            r1 = static_cast<int64_t>(r1.i64 + r6.i64); code++; goto Next;
        case OpCode::AddI_R1_R7_X8:
            r1 = static_cast<int64_t>(r1.i64 + r7.i64); code++; goto Next;
        case OpCode::AddI_R2_R0_X8:
            r2 = static_cast<int64_t>(r2.i64 + r0.i64); code++; goto Next;
        case OpCode::AddI_R2_R1_X8:
            r2 = static_cast<int64_t>(r2.i64 + r1.i64); code++; goto Next;
        case OpCode::AddI_R2_R2_X8:
            r2 = static_cast<int64_t>(r2.i64 + r2.i64); code++; goto Next;
        case OpCode::AddI_R2_R3_X8:
            r2 = static_cast<int64_t>(r2.i64 + r3.i64); code++; goto Next;
        case OpCode::AddI_R2_R4_X8:
            r2 = static_cast<int64_t>(r2.i64 + r4.i64); code++; goto Next;
        case OpCode::AddI_R2_R5_X8:
            r2 = static_cast<int64_t>(r2.i64 + r5.i64); code++; goto Next;
        case OpCode::AddI_R2_R6_X8:
            r2 = static_cast<int64_t>(r2.i64 + r6.i64); code++; goto Next;
        case OpCode::AddI_R2_R7_X8:
            r2 = static_cast<int64_t>(r2.i64 + r7.i64); code++; goto Next;
        case OpCode::AddI_R3_R0_X8:
            r3 = static_cast<int64_t>(r3.i64 + r0.i64); code++; goto Next;
        case OpCode::AddI_R3_R1_X8:
            r3 = static_cast<int64_t>(r3.i64 + r1.i64); code++; goto Next;
        case OpCode::AddI_R3_R2_X8:
            r3 = static_cast<int64_t>(r3.i64 + r2.i64); code++; goto Next;
        case OpCode::AddI_R3_R3_X8:
            r3 = static_cast<int64_t>(r3.i64 + r3.i64); code++; goto Next;
        case OpCode::AddI_R3_R4_X8:
            r3 = static_cast<int64_t>(r3.i64 + r4.i64); code++; goto Next;
        case OpCode::AddI_R3_R5_X8:
            r3 = static_cast<int64_t>(r3.i64 + r5.i64); code++; goto Next;
        case OpCode::AddI_R3_R6_X8:
            r3 = static_cast<int64_t>(r3.i64 + r6.i64); code++; goto Next;
        case OpCode::AddI_R3_R7_X8:
            r3 = static_cast<int64_t>(r3.i64 + r7.i64); code++; goto Next;
        case OpCode::AddI_R4_R0_X8:
            r4 = static_cast<int64_t>(r4.i64 + r0.i64); code++; goto Next;
        case OpCode::AddI_R4_R1_X8:
            r4 = static_cast<int64_t>(r4.i64 + r1.i64); code++; goto Next;
        case OpCode::AddI_R4_R2_X8:
            r4 = static_cast<int64_t>(r4.i64 + r2.i64); code++; goto Next;
        case OpCode::AddI_R4_R3_X8:
            r4 = static_cast<int64_t>(r4.i64 + r3.i64); code++; goto Next;
        case OpCode::AddI_R4_R4_X8:
            r4 = static_cast<int64_t>(r4.i64 + r4.i64); code++; goto Next;
        case OpCode::AddI_R4_R5_X8:
            r4 = static_cast<int64_t>(r4.i64 + r5.i64); code++; goto Next;
        case OpCode::AddI_R4_R6_X8:
            r4 = static_cast<int64_t>(r4.i64 + r6.i64); code++; goto Next;
        case OpCode::AddI_R4_R7_X8:
            r4 = static_cast<int64_t>(r4.i64 + r7.i64); code++; goto Next;
        case OpCode::AddI_R5_R0_X8:
            r5 = static_cast<int64_t>(r5.i64 + r0.i64); code++; goto Next;
        case OpCode::AddI_R5_R1_X8:
            r5 = static_cast<int64_t>(r5.i64 + r1.i64); code++; goto Next;
        case OpCode::AddI_R5_R2_X8:
            r5 = static_cast<int64_t>(r5.i64 + r2.i64); code++; goto Next;
        case OpCode::AddI_R5_R3_X8:
            r5 = static_cast<int64_t>(r5.i64 + r3.i64); code++; goto Next;
        case OpCode::AddI_R5_R4_X8:
            r5 = static_cast<int64_t>(r5.i64 + r4.i64); code++; goto Next;
        case OpCode::AddI_R5_R5_X8:
            r5 = static_cast<int64_t>(r5.i64 + r5.i64); code++; goto Next;
        case OpCode::AddI_R5_R6_X8:
            r5 = static_cast<int64_t>(r5.i64 + r6.i64); code++; goto Next;
        case OpCode::AddI_R5_R7_X8:
            r5 = static_cast<int64_t>(r5.i64 + r7.i64); code++; goto Next;
        case OpCode::AddI_R6_R0_X8:
            r6 = static_cast<int64_t>(r6.i64 + r0.i64); code++; goto Next;
        case OpCode::AddI_R6_R1_X8:
            r6 = static_cast<int64_t>(r6.i64 + r1.i64); code++; goto Next;
        case OpCode::AddI_R6_R2_X8:
            r6 = static_cast<int64_t>(r6.i64 + r2.i64); code++; goto Next;
        case OpCode::AddI_R6_R3_X8:
            r6 = static_cast<int64_t>(r6.i64 + r3.i64); code++; goto Next;
        case OpCode::AddI_R6_R4_X8:
            r6 = static_cast<int64_t>(r6.i64 + r4.i64); code++; goto Next;
        case OpCode::AddI_R6_R5_X8:
            r6 = static_cast<int64_t>(r6.i64 + r5.i64); code++; goto Next;
        case OpCode::AddI_R6_R6_X8:
            r6 = static_cast<int64_t>(r6.i64 + r6.i64); code++; goto Next;
        case OpCode::AddI_R6_R7_X8:
            r6 = static_cast<int64_t>(r6.i64 + r7.i64); code++; goto Next;
        case OpCode::AddI_R7_R0_X8:
            r7 = static_cast<int64_t>(r7.i64 + r0.i64); code++; goto Next;
        case OpCode::AddI_R7_R1_X8:
            r7 = static_cast<int64_t>(r7.i64 + r1.i64); code++; goto Next;
        case OpCode::AddI_R7_R2_X8:
            r7 = static_cast<int64_t>(r7.i64 + r2.i64); code++; goto Next;
        case OpCode::AddI_R7_R3_X8:
            r7 = static_cast<int64_t>(r7.i64 + r3.i64); code++; goto Next;
        case OpCode::AddI_R7_R4_X8:
            r7 = static_cast<int64_t>(r7.i64 + r4.i64); code++; goto Next;
        case OpCode::AddI_R7_R5_X8:
            r7 = static_cast<int64_t>(r7.i64 + r5.i64); code++; goto Next;
        case OpCode::AddI_R7_R6_X8:
            r7 = static_cast<int64_t>(r7.i64 + r6.i64); code++; goto Next;
        case OpCode::AddI_R7_R7_X8:
            r7 = static_cast<int64_t>(r7.i64 + r7.i64); code++; goto Next;
        ...
        case OpCode::AddU_R0_R0_X1:
            r0 = static_cast<uint8_t>(r0.u8 + r0.u8); code++; goto Next;
        case OpCode::AddU_R0_R1_X1:
            r0 = static_cast<uint8_t>(r0.u8 + r1.u8); code++; goto Next;
        case OpCode::AddU_R0_R2_X1:
            r0 = static_cast<uint8_t>(r0.u8 + r2.u8); code++; goto Next;
        case OpCode::AddU_R0_R3_X1:
            r0 = static_cast<uint8_t>(r0.u8 + r3.u8); code++; goto Next;
        case OpCode::AddU_R0_R4_X1:
            r0 = static_cast<uint8_t>(r0.u8 + r4.u8); code++; goto Next;
        case OpCode::AddU_R0_R5_X1:
            r0 = static_cast<uint8_t>(r0.u8 + r5.u8); code++; goto Next;
        case OpCode::AddU_R0_R6_X1:
            r0 = static_cast<uint8_t>(r0.u8 + r6.u8); code++; goto Next;
        case OpCode::AddU_R0_R7_X1:
            r0 = static_cast<uint8_t>(r0.u8 + r7.u8); code++; goto Next;
        case OpCode::AddU_R1_R0_X1:
            r1 = static_cast<uint8_t>(r1.u8 + r0.u8); code++; goto Next;
        case OpCode::AddU_R1_R1_X1:
            r1 = static_cast<uint8_t>(r1.u8 + r1.u8); code++; goto Next;
        case OpCode::AddU_R1_R2_X1:
            r1 = static_cast<uint8_t>(r1.u8 + r2.u8); code++; goto Next;
        case OpCode::AddU_R1_R3_X1:
            r1 = static_cast<uint8_t>(r1.u8 + r3.u8); code++; goto Next;
        case OpCode::AddU_R1_R4_X1:
            r1 = static_cast<uint8_t>(r1.u8 + r4.u8); code++; goto Next;
        case OpCode::AddU_R1_R5_X1:
            r1 = static_cast<uint8_t>(r1.u8 + r5.u8); code++; goto Next;
        case OpCode::AddU_R1_R6_X1:
            r1 = static_cast<uint8_t>(r1.u8 + r6.u8); code++; goto Next;
        case OpCode::AddU_R1_R7_X1:
            r1 = static_cast<uint8_t>(r1.u8 + r7.u8); code++; goto Next;
        case OpCode::AddU_R2_R0_X1:
            r2 = static_cast<uint8_t>(r2.u8 + r0.u8); code++; goto Next;
        case OpCode::AddU_R2_R1_X1:
            r2 = static_cast<uint8_t>(r2.u8 + r1.u8); code++; goto Next;
        case OpCode::AddU_R2_R2_X1:
            r2 = static_cast<uint8_t>(r2.u8 + r2.u8); code++; goto Next;
        case OpCode::AddU_R2_R3_X1:
            r2 = static_cast<uint8_t>(r2.u8 + r3.u8); code++; goto Next;
        case OpCode::AddU_R2_R4_X1:
            r2 = static_cast<uint8_t>(r2.u8 + r4.u8); code++; goto Next;
        case OpCode::AddU_R2_R5_X1:
            r2 = static_cast<uint8_t>(r2.u8 + r5.u8); code++; goto Next;
        case OpCode::AddU_R2_R6_X1:
            r2 = static_cast<uint8_t>(r2.u8 + r6.u8); code++; goto Next;
        case OpCode::AddU_R2_R7_X1:
            r2 = static_cast<uint8_t>(r2.u8 + r7.u8); code++; goto Next;
        case OpCode::AddU_R3_R0_X1:
            r3 = static_cast<uint8_t>(r3.u8 + r0.u8); code++; goto Next;
        case OpCode::AddU_R3_R1_X1:
            r3 = static_cast<uint8_t>(r3.u8 + r1.u8); code++; goto Next;
        case OpCode::AddU_R3_R2_X1:
            r3 = static_cast<uint8_t>(r3.u8 + r2.u8); code++; goto Next;
        case OpCode::AddU_R3_R3_X1:
            r3 = static_cast<uint8_t>(r3.u8 + r3.u8); code++; goto Next;
        case OpCode::AddU_R3_R4_X1:
            r3 = static_cast<uint8_t>(r3.u8 + r4.u8); code++; goto Next;
        case OpCode::AddU_R3_R5_X1:
            r3 = static_cast<uint8_t>(r3.u8 + r5.u8); code++; goto Next;
        case OpCode::AddU_R3_R6_X1:
            r3 = static_cast<uint8_t>(r3.u8 + r6.u8); code++; goto Next;
        case OpCode::AddU_R3_R7_X1:
            r3 = static_cast<uint8_t>(r3.u8 + r7.u8); code++; goto Next;
        case OpCode::AddU_R4_R0_X1:
            r4 = static_cast<uint8_t>(r4.u8 + r0.u8); code++; goto Next;
        case OpCode::AddU_R4_R1_X1:
            r4 = static_cast<uint8_t>(r4.u8 + r1.u8); code++; goto Next;
        case OpCode::AddU_R4_R2_X1:
            r4 = static_cast<uint8_t>(r4.u8 + r2.u8); code++; goto Next;
        case OpCode::AddU_R4_R3_X1:
            r4 = static_cast<uint8_t>(r4.u8 + r3.u8); code++; goto Next;
        case OpCode::AddU_R4_R4_X1:
            r4 = static_cast<uint8_t>(r4.u8 + r4.u8); code++; goto Next;
        case OpCode::AddU_R4_R5_X1:
            r4 = static_cast<uint8_t>(r4.u8 + r5.u8); code++; goto Next;
        case OpCode::AddU_R4_R6_X1:
            r4 = static_cast<uint8_t>(r4.u8 + r6.u8); code++; goto Next;
        case OpCode::AddU_R4_R7_X1:
            r4 = static_cast<uint8_t>(r4.u8 + r7.u8); code++; goto Next;
        case OpCode::AddU_R5_R0_X1:
            r5 = static_cast<uint8_t>(r5.u8 + r0.u8); code++; goto Next;
        case OpCode::AddU_R5_R1_X1:
            r5 = static_cast<uint8_t>(r5.u8 + r1.u8); code++; goto Next;
        case OpCode::AddU_R5_R2_X1:
            r5 = static_cast<uint8_t>(r5.u8 + r2.u8); code++; goto Next;
        case OpCode::AddU_R5_R3_X1:
            r5 = static_cast<uint8_t>(r5.u8 + r3.u8); code++; goto Next;
        case OpCode::AddU_R5_R4_X1:
            r5 = static_cast<uint8_t>(r5.u8 + r4.u8); code++; goto Next;
        case OpCode::AddU_R5_R5_X1:
            r5 = static_cast<uint8_t>(r5.u8 + r5.u8); code++; goto Next;
        case OpCode::AddU_R5_R6_X1:
            r5 = static_cast<uint8_t>(r5.u8 + r6.u8); code++; goto Next;
        case OpCode::AddU_R5_R7_X1:
            r5 = static_cast<uint8_t>(r5.u8 + r7.u8); code++; goto Next;
        case OpCode::AddU_R6_R0_X1:
            r6 = static_cast<uint8_t>(r6.u8 + r0.u8); code++; goto Next;
        case OpCode::AddU_R6_R1_X1:
            r6 = static_cast<uint8_t>(r6.u8 + r1.u8); code++; goto Next;
        case OpCode::AddU_R6_R2_X1:
            r6 = static_cast<uint8_t>(r6.u8 + r2.u8); code++; goto Next;
        case OpCode::AddU_R6_R3_X1:
            r6 = static_cast<uint8_t>(r6.u8 + r3.u8); code++; goto Next;
        case OpCode::AddU_R6_R4_X1:
            r6 = static_cast<uint8_t>(r6.u8 + r4.u8); code++; goto Next;
        case OpCode::AddU_R6_R5_X1:
            r6 = static_cast<uint8_t>(r6.u8 + r5.u8); code++; goto Next;
        case OpCode::AddU_R6_R6_X1:
            r6 = static_cast<uint8_t>(r6.u8 + r6.u8); code++; goto Next;
        case OpCode::AddU_R6_R7_X1:
            r6 = static_cast<uint8_t>(r6.u8 + r7.u8); code++; goto Next;
        case OpCode::AddU_R7_R0_X1:
            r7 = static_cast<uint8_t>(r7.u8 + r0.u8); code++; goto Next;
        case OpCode::AddU_R7_R1_X1:
            r7 = static_cast<uint8_t>(r7.u8 + r1.u8); code++; goto Next;
        case OpCode::AddU_R7_R2_X1:
            r7 = static_cast<uint8_t>(r7.u8 + r2.u8); code++; goto Next;
        case OpCode::AddU_R7_R3_X1:
            r7 = static_cast<uint8_t>(r7.u8 + r3.u8); code++; goto Next;
        case OpCode::AddU_R7_R4_X1:
            r7 = static_cast<uint8_t>(r7.u8 + r4.u8); code++; goto Next;
        case OpCode::AddU_R7_R5_X1:
            r7 = static_cast<uint8_t>(r7.u8 + r5.u8); code++; goto Next;
        case OpCode::AddU_R7_R6_X1:
            r7 = static_cast<uint8_t>(r7.u8 + r6.u8); code++; goto Next;
        case OpCode::AddU_R7_R7_X1:
            r7 = static_cast<uint8_t>(r7.u8 + r7.u8); code++; goto Next;
        ...
        case OpCode::AddU_R0_R0_X2:
            r0 = static_cast<uint16_t>(r0.u16 + r0.u16); code++; goto Next;
        case OpCode::AddU_R0_R1_X2:
            r0 = static_cast<uint16_t>(r0.u16 + r1.u16); code++; goto Next;
        case OpCode::AddU_R0_R2_X2:
            r0 = static_cast<uint16_t>(r0.u16 + r2.u16); code++; goto Next;
        case OpCode::AddU_R0_R3_X2:
            r0 = static_cast<uint16_t>(r0.u16 + r3.u16); code++; goto Next;
        case OpCode::AddU_R0_R4_X2:
            r0 = static_cast<uint16_t>(r0.u16 + r4.u16); code++; goto Next;
        case OpCode::AddU_R0_R5_X2:
            r0 = static_cast<uint16_t>(r0.u16 + r5.u16); code++; goto Next;
        case OpCode::AddU_R0_R6_X2:
            r0 = static_cast<uint16_t>(r0.u16 + r6.u16); code++; goto Next;
        case OpCode::AddU_R0_R7_X2:
            r0 = static_cast<uint16_t>(r0.u16 + r7.u16); code++; goto Next;
        case OpCode::AddU_R1_R0_X2:
            r1 = static_cast<uint16_t>(r1.u16 + r0.u16); code++; goto Next;
        case OpCode::AddU_R1_R1_X2:
            r1 = static_cast<uint16_t>(r1.u16 + r1.u16); code++; goto Next;
        case OpCode::AddU_R1_R2_X2:
            r1 = static_cast<uint16_t>(r1.u16 + r2.u16); code++; goto Next;
        case OpCode::AddU_R1_R3_X2:
            r1 = static_cast<uint16_t>(r1.u16 + r3.u16); code++; goto Next;
        case OpCode::AddU_R1_R4_X2:
            r1 = static_cast<uint16_t>(r1.u16 + r4.u16); code++; goto Next;
        case OpCode::AddU_R1_R5_X2:
            r1 = static_cast<uint16_t>(r1.u16 + r5.u16); code++; goto Next;
        case OpCode::AddU_R1_R6_X2:
            r1 = static_cast<uint16_t>(r1.u16 + r6.u16); code++; goto Next;
        case OpCode::AddU_R1_R7_X2:
            r1 = static_cast<uint16_t>(r1.u16 + r7.u16); code++; goto Next;
        case OpCode::AddU_R2_R0_X2:
            r2 = static_cast<uint16_t>(r2.u16 + r0.u16); code++; goto Next;
        case OpCode::AddU_R2_R1_X2:
            r2 = static_cast<uint16_t>(r2.u16 + r1.u16); code++; goto Next;
        case OpCode::AddU_R2_R2_X2:
            r2 = static_cast<uint16_t>(r2.u16 + r2.u16); code++; goto Next;
        case OpCode::AddU_R2_R3_X2:
            r2 = static_cast<uint16_t>(r2.u16 + r3.u16); code++; goto Next;
        case OpCode::AddU_R2_R4_X2:
            r2 = static_cast<uint16_t>(r2.u16 + r4.u16); code++; goto Next;
        case OpCode::AddU_R2_R5_X2:
            r2 = static_cast<uint16_t>(r2.u16 + r5.u16); code++; goto Next;
        case OpCode::AddU_R2_R6_X2:
            r2 = static_cast<uint16_t>(r2.u16 + r6.u16); code++; goto Next;
        case OpCode::AddU_R2_R7_X2:
            r2 = static_cast<uint16_t>(r2.u16 + r7.u16); code++; goto Next;
        case OpCode::AddU_R3_R0_X2:
            r3 = static_cast<uint16_t>(r3.u16 + r0.u16); code++; goto Next;
        case OpCode::AddU_R3_R1_X2:
            r3 = static_cast<uint16_t>(r3.u16 + r1.u16); code++; goto Next;
        case OpCode::AddU_R3_R2_X2:
            r3 = static_cast<uint16_t>(r3.u16 + r2.u16); code++; goto Next;
        case OpCode::AddU_R3_R3_X2:
            r3 = static_cast<uint16_t>(r3.u16 + r3.u16); code++; goto Next;
        case OpCode::AddU_R3_R4_X2:
            r3 = static_cast<uint16_t>(r3.u16 + r4.u16); code++; goto Next;
        case OpCode::AddU_R3_R5_X2:
            r3 = static_cast<uint16_t>(r3.u16 + r5.u16); code++; goto Next;
        case OpCode::AddU_R3_R6_X2:
            r3 = static_cast<uint16_t>(r3.u16 + r6.u16); code++; goto Next;
        case OpCode::AddU_R3_R7_X2:
            r3 = static_cast<uint16_t>(r3.u16 + r7.u16); code++; goto Next;
        case OpCode::AddU_R4_R0_X2:
            r4 = static_cast<uint16_t>(r4.u16 + r0.u16); code++; goto Next;
        case OpCode::AddU_R4_R1_X2:
            r4 = static_cast<uint16_t>(r4.u16 + r1.u16); code++; goto Next;
        case OpCode::AddU_R4_R2_X2:
            r4 = static_cast<uint16_t>(r4.u16 + r2.u16); code++; goto Next;
        case OpCode::AddU_R4_R3_X2:
            r4 = static_cast<uint16_t>(r4.u16 + r3.u16); code++; goto Next;
        case OpCode::AddU_R4_R4_X2:
            r4 = static_cast<uint16_t>(r4.u16 + r4.u16); code++; goto Next;
        case OpCode::AddU_R4_R5_X2:
            r4 = static_cast<uint16_t>(r4.u16 + r5.u16); code++; goto Next;
        case OpCode::AddU_R4_R6_X2:
            r4 = static_cast<uint16_t>(r4.u16 + r6.u16); code++; goto Next;
        case OpCode::AddU_R4_R7_X2:
            r4 = static_cast<uint16_t>(r4.u16 + r7.u16); code++; goto Next;
        case OpCode::AddU_R5_R0_X2:
            r5 = static_cast<uint16_t>(r5.u16 + r0.u16); code++; goto Next;
        case OpCode::AddU_R5_R1_X2:
            r5 = static_cast<uint16_t>(r5.u16 + r1.u16); code++; goto Next;
        case OpCode::AddU_R5_R2_X2:
            r5 = static_cast<uint16_t>(r5.u16 + r2.u16); code++; goto Next;
        case OpCode::AddU_R5_R3_X2:
            r5 = static_cast<uint16_t>(r5.u16 + r3.u16); code++; goto Next;
        case OpCode::AddU_R5_R4_X2:
            r5 = static_cast<uint16_t>(r5.u16 + r4.u16); code++; goto Next;
        case OpCode::AddU_R5_R5_X2:
            r5 = static_cast<uint16_t>(r5.u16 + r5.u16); code++; goto Next;
        case OpCode::AddU_R5_R6_X2:
            r5 = static_cast<uint16_t>(r5.u16 + r6.u16); code++; goto Next;
        case OpCode::AddU_R5_R7_X2:
            r5 = static_cast<uint16_t>(r5.u16 + r7.u16); code++; goto Next;
        case OpCode::AddU_R6_R0_X2:
            r6 = static_cast<uint16_t>(r6.u16 + r0.u16); code++; goto Next;
        case OpCode::AddU_R6_R1_X2:
            r6 = static_cast<uint16_t>(r6.u16 + r1.u16); code++; goto Next;
        case OpCode::AddU_R6_R2_X2:
            r6 = static_cast<uint16_t>(r6.u16 + r2.u16); code++; goto Next;
        case OpCode::AddU_R6_R3_X2:
            r6 = static_cast<uint16_t>(r6.u16 + r3.u16); code++; goto Next;
        case OpCode::AddU_R6_R4_X2:
            r6 = static_cast<uint16_t>(r6.u16 + r4.u16); code++; goto Next;
        case OpCode::AddU_R6_R5_X2:
            r6 = static_cast<uint16_t>(r6.u16 + r5.u16); code++; goto Next;
        case OpCode::AddU_R6_R6_X2:
            r6 = static_cast<uint16_t>(r6.u16 + r6.u16); code++; goto Next;
        case OpCode::AddU_R6_R7_X2:
            r6 = static_cast<uint16_t>(r6.u16 + r7.u16); code++; goto Next;
        case OpCode::AddU_R7_R0_X2:
            r7 = static_cast<uint16_t>(r7.u16 + r0.u16); code++; goto Next;
        case OpCode::AddU_R7_R1_X2:
            r7 = static_cast<uint16_t>(r7.u16 + r1.u16); code++; goto Next;
        case OpCode::AddU_R7_R2_X2:
            r7 = static_cast<uint16_t>(r7.u16 + r2.u16); code++; goto Next;
        case OpCode::AddU_R7_R3_X2:
            r7 = static_cast<uint16_t>(r7.u16 + r3.u16); code++; goto Next;
        case OpCode::AddU_R7_R4_X2:
            r7 = static_cast<uint16_t>(r7.u16 + r4.u16); code++; goto Next;
        case OpCode::AddU_R7_R5_X2:
            r7 = static_cast<uint16_t>(r7.u16 + r5.u16); code++; goto Next;
        case OpCode::AddU_R7_R6_X2:
            r7 = static_cast<uint16_t>(r7.u16 + r6.u16); code++; goto Next;
        case OpCode::AddU_R7_R7_X2:
            r7 = static_cast<uint16_t>(r7.u16 + r7.u16); code++; goto Next;
        ...
        case OpCode::AddU_R0_R0_X4:
            r0 = static_cast<uint32_t>(r0.u32 + r0.u32); code++; goto Next;
        case OpCode::AddU_R0_R1_X4:
            r0 = static_cast<uint32_t>(r0.u32 + r1.u32); code++; goto Next;
        case OpCode::AddU_R0_R2_X4:
            r0 = static_cast<uint32_t>(r0.u32 + r2.u32); code++; goto Next;
        case OpCode::AddU_R0_R3_X4:
            r0 = static_cast<uint32_t>(r0.u32 + r3.u32); code++; goto Next;
        case OpCode::AddU_R0_R4_X4:
            r0 = static_cast<uint32_t>(r0.u32 + r4.u32); code++; goto Next;
        case OpCode::AddU_R0_R5_X4:
            r0 = static_cast<uint32_t>(r0.u32 + r5.u32); code++; goto Next;
        case OpCode::AddU_R0_R6_X4:
            r0 = static_cast<uint32_t>(r0.u32 + r6.u32); code++; goto Next;
        case OpCode::AddU_R0_R7_X4:
            r0 = static_cast<uint32_t>(r0.u32 + r7.u32); code++; goto Next;
        case OpCode::AddU_R1_R0_X4:
            r1 = static_cast<uint32_t>(r1.u32 + r0.u32); code++; goto Next;
        case OpCode::AddU_R1_R1_X4:
            r1 = static_cast<uint32_t>(r1.u32 + r1.u32); code++; goto Next;
        case OpCode::AddU_R1_R2_X4:
            r1 = static_cast<uint32_t>(r1.u32 + r2.u32); code++; goto Next;
        case OpCode::AddU_R1_R3_X4:
            r1 = static_cast<uint32_t>(r1.u32 + r3.u32); code++; goto Next;
        case OpCode::AddU_R1_R4_X4:
            r1 = static_cast<uint32_t>(r1.u32 + r4.u32); code++; goto Next;
        case OpCode::AddU_R1_R5_X4:
            r1 = static_cast<uint32_t>(r1.u32 + r5.u32); code++; goto Next;
        case OpCode::AddU_R1_R6_X4:
            r1 = static_cast<uint32_t>(r1.u32 + r6.u32); code++; goto Next;
        case OpCode::AddU_R1_R7_X4:
            r1 = static_cast<uint32_t>(r1.u32 + r7.u32); code++; goto Next;
        case OpCode::AddU_R2_R0_X4:
            r2 = static_cast<uint32_t>(r2.u32 + r0.u32); code++; goto Next;
        case OpCode::AddU_R2_R1_X4:
            r2 = static_cast<uint32_t>(r2.u32 + r1.u32); code++; goto Next;
        case OpCode::AddU_R2_R2_X4:
            r2 = static_cast<uint32_t>(r2.u32 + r2.u32); code++; goto Next;
        case OpCode::AddU_R2_R3_X4:
            r2 = static_cast<uint32_t>(r2.u32 + r3.u32); code++; goto Next;
        case OpCode::AddU_R2_R4_X4:
            r2 = static_cast<uint32_t>(r2.u32 + r4.u32); code++; goto Next;
        case OpCode::AddU_R2_R5_X4:
            r2 = static_cast<uint32_t>(r2.u32 + r5.u32); code++; goto Next;
        case OpCode::AddU_R2_R6_X4:
            r2 = static_cast<uint32_t>(r2.u32 + r6.u32); code++; goto Next;
        case OpCode::AddU_R2_R7_X4:
            r2 = static_cast<uint32_t>(r2.u32 + r7.u32); code++; goto Next;
        case OpCode::AddU_R3_R0_X4:
            r3 = static_cast<uint32_t>(r3.u32 + r0.u32); code++; goto Next;
        case OpCode::AddU_R3_R1_X4:
            r3 = static_cast<uint32_t>(r3.u32 + r1.u32); code++; goto Next;
        case OpCode::AddU_R3_R2_X4:
            r3 = static_cast<uint32_t>(r3.u32 + r2.u32); code++; goto Next;
        case OpCode::AddU_R3_R3_X4:
            r3 = static_cast<uint32_t>(r3.u32 + r3.u32); code++; goto Next;
        case OpCode::AddU_R3_R4_X4:
            r3 = static_cast<uint32_t>(r3.u32 + r4.u32); code++; goto Next;
        case OpCode::AddU_R3_R5_X4:
            r3 = static_cast<uint32_t>(r3.u32 + r5.u32); code++; goto Next;
        case OpCode::AddU_R3_R6_X4:
            r3 = static_cast<uint32_t>(r3.u32 + r6.u32); code++; goto Next;
        case OpCode::AddU_R3_R7_X4:
            r3 = static_cast<uint32_t>(r3.u32 + r7.u32); code++; goto Next;
        case OpCode::AddU_R4_R0_X4:
            r4 = static_cast<uint32_t>(r4.u32 + r0.u32); code++; goto Next;
        case OpCode::AddU_R4_R1_X4:
            r4 = static_cast<uint32_t>(r4.u32 + r1.u32); code++; goto Next;
        case OpCode::AddU_R4_R2_X4:
            r4 = static_cast<uint32_t>(r4.u32 + r2.u32); code++; goto Next;
        case OpCode::AddU_R4_R3_X4:
            r4 = static_cast<uint32_t>(r4.u32 + r3.u32); code++; goto Next;
        case OpCode::AddU_R4_R4_X4:
            r4 = static_cast<uint32_t>(r4.u32 + r4.u32); code++; goto Next;
        case OpCode::AddU_R4_R5_X4:
            r4 = static_cast<uint32_t>(r4.u32 + r5.u32); code++; goto Next;
        case OpCode::AddU_R4_R6_X4:
            r4 = static_cast<uint32_t>(r4.u32 + r6.u32); code++; goto Next;
        case OpCode::AddU_R4_R7_X4:
            r4 = static_cast<uint32_t>(r4.u32 + r7.u32); code++; goto Next;
        case OpCode::AddU_R5_R0_X4:
            r5 = static_cast<uint32_t>(r5.u32 + r0.u32); code++; goto Next;
        case OpCode::AddU_R5_R1_X4:
            r5 = static_cast<uint32_t>(r5.u32 + r1.u32); code++; goto Next;
        case OpCode::AddU_R5_R2_X4:
            r5 = static_cast<uint32_t>(r5.u32 + r2.u32); code++; goto Next;
        case OpCode::AddU_R5_R3_X4:
            r5 = static_cast<uint32_t>(r5.u32 + r3.u32); code++; goto Next;
        case OpCode::AddU_R5_R4_X4:
            r5 = static_cast<uint32_t>(r5.u32 + r4.u32); code++; goto Next;
        case OpCode::AddU_R5_R5_X4:
            r5 = static_cast<uint32_t>(r5.u32 + r5.u32); code++; goto Next;
        case OpCode::AddU_R5_R6_X4:
            r5 = static_cast<uint32_t>(r5.u32 + r6.u32); code++; goto Next;
        case OpCode::AddU_R5_R7_X4:
            r5 = static_cast<uint32_t>(r5.u32 + r7.u32); code++; goto Next;
        case OpCode::AddU_R6_R0_X4:
            r6 = static_cast<uint32_t>(r6.u32 + r0.u32); code++; goto Next;
        case OpCode::AddU_R6_R1_X4:
            r6 = static_cast<uint32_t>(r6.u32 + r1.u32); code++; goto Next;
        case OpCode::AddU_R6_R2_X4:
            r6 = static_cast<uint32_t>(r6.u32 + r2.u32); code++; goto Next;
        case OpCode::AddU_R6_R3_X4:
            r6 = static_cast<uint32_t>(r6.u32 + r3.u32); code++; goto Next;
        case OpCode::AddU_R6_R4_X4:
            r6 = static_cast<uint32_t>(r6.u32 + r4.u32); code++; goto Next;
        case OpCode::AddU_R6_R5_X4:
            r6 = static_cast<uint32_t>(r6.u32 + r5.u32); code++; goto Next;
        case OpCode::AddU_R6_R6_X4:
            r6 = static_cast<uint32_t>(r6.u32 + r6.u32); code++; goto Next;
        case OpCode::AddU_R6_R7_X4:
            r6 = static_cast<uint32_t>(r6.u32 + r7.u32); code++; goto Next;
        case OpCode::AddU_R7_R0_X4:
            r7 = static_cast<uint32_t>(r7.u32 + r0.u32); code++; goto Next;
        case OpCode::AddU_R7_R1_X4:
            r7 = static_cast<uint32_t>(r7.u32 + r1.u32); code++; goto Next;
        case OpCode::AddU_R7_R2_X4:
            r7 = static_cast<uint32_t>(r7.u32 + r2.u32); code++; goto Next;
        case OpCode::AddU_R7_R3_X4:
            r7 = static_cast<uint32_t>(r7.u32 + r3.u32); code++; goto Next;
        case OpCode::AddU_R7_R4_X4:
            r7 = static_cast<uint32_t>(r7.u32 + r4.u32); code++; goto Next;
        case OpCode::AddU_R7_R5_X4:
            r7 = static_cast<uint32_t>(r7.u32 + r5.u32); code++; goto Next;
        case OpCode::AddU_R7_R6_X4:
            r7 = static_cast<uint32_t>(r7.u32 + r6.u32); code++; goto Next;
        case OpCode::AddU_R7_R7_X4:
            r7 = static_cast<uint32_t>(r7.u32 + r7.u32); code++; goto Next;
        ...
        case OpCode::AddU_R0_R0_X8:
            r0 = static_cast<uint64_t>(r0.u64 + r0.u64); code++; goto Next;
        case OpCode::AddU_R0_R1_X8:
            r0 = static_cast<uint64_t>(r0.u64 + r1.u64); code++; goto Next;
        case OpCode::AddU_R0_R2_X8:
            r0 = static_cast<uint64_t>(r0.u64 + r2.u64); code++; goto Next;
        case OpCode::AddU_R0_R3_X8:
            r0 = static_cast<uint64_t>(r0.u64 + r3.u64); code++; goto Next;
        case OpCode::AddU_R0_R4_X8:
            r0 = static_cast<uint64_t>(r0.u64 + r4.u64); code++; goto Next;
        case OpCode::AddU_R0_R5_X8:
            r0 = static_cast<uint64_t>(r0.u64 + r5.u64); code++; goto Next;
        case OpCode::AddU_R0_R6_X8:
            r0 = static_cast<uint64_t>(r0.u64 + r6.u64); code++; goto Next;
        case OpCode::AddU_R0_R7_X8:
            r0 = static_cast<uint64_t>(r0.u64 + r7.u64); code++; goto Next;
        case OpCode::AddU_R1_R0_X8:
            r1 = static_cast<uint64_t>(r1.u64 + r0.u64); code++; goto Next;
        case OpCode::AddU_R1_R1_X8:
            r1 = static_cast<uint64_t>(r1.u64 + r1.u64); code++; goto Next;
        case OpCode::AddU_R1_R2_X8:
            r1 = static_cast<uint64_t>(r1.u64 + r2.u64); code++; goto Next;
        case OpCode::AddU_R1_R3_X8:
            r1 = static_cast<uint64_t>(r1.u64 + r3.u64); code++; goto Next;
        case OpCode::AddU_R1_R4_X8:
            r1 = static_cast<uint64_t>(r1.u64 + r4.u64); code++; goto Next;
        case OpCode::AddU_R1_R5_X8:
            r1 = static_cast<uint64_t>(r1.u64 + r5.u64); code++; goto Next;
        case OpCode::AddU_R1_R6_X8:
            r1 = static_cast<uint64_t>(r1.u64 + r6.u64); code++; goto Next;
        case OpCode::AddU_R1_R7_X8:
            r1 = static_cast<uint64_t>(r1.u64 + r7.u64); code++; goto Next;
        case OpCode::AddU_R2_R0_X8:
            r2 = static_cast<uint64_t>(r2.u64 + r0.u64); code++; goto Next;
        case OpCode::AddU_R2_R1_X8:
            r2 = static_cast<uint64_t>(r2.u64 + r1.u64); code++; goto Next;
        case OpCode::AddU_R2_R2_X8:
            r2 = static_cast<uint64_t>(r2.u64 + r2.u64); code++; goto Next;
        case OpCode::AddU_R2_R3_X8:
            r2 = static_cast<uint64_t>(r2.u64 + r3.u64); code++; goto Next;
        case OpCode::AddU_R2_R4_X8:
            r2 = static_cast<uint64_t>(r2.u64 + r4.u64); code++; goto Next;
        case OpCode::AddU_R2_R5_X8:
            r2 = static_cast<uint64_t>(r2.u64 + r5.u64); code++; goto Next;
        case OpCode::AddU_R2_R6_X8:
            r2 = static_cast<uint64_t>(r2.u64 + r6.u64); code++; goto Next;
        case OpCode::AddU_R2_R7_X8:
            r2 = static_cast<uint64_t>(r2.u64 + r7.u64); code++; goto Next;
        case OpCode::AddU_R3_R0_X8:
            r3 = static_cast<uint64_t>(r3.u64 + r0.u64); code++; goto Next;
        case OpCode::AddU_R3_R1_X8:
            r3 = static_cast<uint64_t>(r3.u64 + r1.u64); code++; goto Next;
        case OpCode::AddU_R3_R2_X8:
            r3 = static_cast<uint64_t>(r3.u64 + r2.u64); code++; goto Next;
        case OpCode::AddU_R3_R3_X8:
            r3 = static_cast<uint64_t>(r3.u64 + r3.u64); code++; goto Next;
        case OpCode::AddU_R3_R4_X8:
            r3 = static_cast<uint64_t>(r3.u64 + r4.u64); code++; goto Next;
        case OpCode::AddU_R3_R5_X8:
            r3 = static_cast<uint64_t>(r3.u64 + r5.u64); code++; goto Next;
        case OpCode::AddU_R3_R6_X8:
            r3 = static_cast<uint64_t>(r3.u64 + r6.u64); code++; goto Next;
        case OpCode::AddU_R3_R7_X8:
            r3 = static_cast<uint64_t>(r3.u64 + r7.u64); code++; goto Next;
        case OpCode::AddU_R4_R0_X8:
            r4 = static_cast<uint64_t>(r4.u64 + r0.u64); code++; goto Next;
        case OpCode::AddU_R4_R1_X8:
            r4 = static_cast<uint64_t>(r4.u64 + r1.u64); code++; goto Next;
        case OpCode::AddU_R4_R2_X8:
            r4 = static_cast<uint64_t>(r4.u64 + r2.u64); code++; goto Next;
        case OpCode::AddU_R4_R3_X8:
            r4 = static_cast<uint64_t>(r4.u64 + r3.u64); code++; goto Next;
        case OpCode::AddU_R4_R4_X8:
            r4 = static_cast<uint64_t>(r4.u64 + r4.u64); code++; goto Next;
        case OpCode::AddU_R4_R5_X8:
            r4 = static_cast<uint64_t>(r4.u64 + r5.u64); code++; goto Next;
        case OpCode::AddU_R4_R6_X8:
            r4 = static_cast<uint64_t>(r4.u64 + r6.u64); code++; goto Next;
        case OpCode::AddU_R4_R7_X8:
            r4 = static_cast<uint64_t>(r4.u64 + r7.u64); code++; goto Next;
        case OpCode::AddU_R5_R0_X8:
            r5 = static_cast<uint64_t>(r5.u64 + r0.u64); code++; goto Next;
        case OpCode::AddU_R5_R1_X8:
            r5 = static_cast<uint64_t>(r5.u64 + r1.u64); code++; goto Next;
        case OpCode::AddU_R5_R2_X8:
            r5 = static_cast<uint64_t>(r5.u64 + r2.u64); code++; goto Next;
        case OpCode::AddU_R5_R3_X8:
            r5 = static_cast<uint64_t>(r5.u64 + r3.u64); code++; goto Next;
        case OpCode::AddU_R5_R4_X8:
            r5 = static_cast<uint64_t>(r5.u64 + r4.u64); code++; goto Next;
        case OpCode::AddU_R5_R5_X8:
            r5 = static_cast<uint64_t>(r5.u64 + r5.u64); code++; goto Next;
        case OpCode::AddU_R5_R6_X8:
            r5 = static_cast<uint64_t>(r5.u64 + r6.u64); code++; goto Next;
        case OpCode::AddU_R5_R7_X8:
            r5 = static_cast<uint64_t>(r5.u64 + r7.u64); code++; goto Next;
        case OpCode::AddU_R6_R0_X8:
            r6 = static_cast<uint64_t>(r6.u64 + r0.u64); code++; goto Next;
        case OpCode::AddU_R6_R1_X8:
            r6 = static_cast<uint64_t>(r6.u64 + r1.u64); code++; goto Next;
        case OpCode::AddU_R6_R2_X8:
            r6 = static_cast<uint64_t>(r6.u64 + r2.u64); code++; goto Next;
        case OpCode::AddU_R6_R3_X8:
            r6 = static_cast<uint64_t>(r6.u64 + r3.u64); code++; goto Next;
        case OpCode::AddU_R6_R4_X8:
            r6 = static_cast<uint64_t>(r6.u64 + r4.u64); code++; goto Next;
        case OpCode::AddU_R6_R5_X8:
            r6 = static_cast<uint64_t>(r6.u64 + r5.u64); code++; goto Next;
        case OpCode::AddU_R6_R6_X8:
            r6 = static_cast<uint64_t>(r6.u64 + r6.u64); code++; goto Next;
        case OpCode::AddU_R6_R7_X8:
            r6 = static_cast<uint64_t>(r6.u64 + r7.u64); code++; goto Next;
        case OpCode::AddU_R7_R0_X8:
            r7 = static_cast<uint64_t>(r7.u64 + r0.u64); code++; goto Next;
        case OpCode::AddU_R7_R1_X8:
            r7 = static_cast<uint64_t>(r7.u64 + r1.u64); code++; goto Next;
        case OpCode::AddU_R7_R2_X8:
            r7 = static_cast<uint64_t>(r7.u64 + r2.u64); code++; goto Next;
        case OpCode::AddU_R7_R3_X8:
            r7 = static_cast<uint64_t>(r7.u64 + r3.u64); code++; goto Next;
        case OpCode::AddU_R7_R4_X8:
            r7 = static_cast<uint64_t>(r7.u64 + r4.u64); code++; goto Next;
        case OpCode::AddU_R7_R5_X8:
            r7 = static_cast<uint64_t>(r7.u64 + r5.u64); code++; goto Next;
        case OpCode::AddU_R7_R6_X8:
            r7 = static_cast<uint64_t>(r7.u64 + r6.u64); code++; goto Next;
        case OpCode::AddU_R7_R7_X8:
            r7 = static_cast<uint64_t>(r7.u64 + r7.u64); code++; goto Next;
        ...
        case OpCode::AddF_R0_R0_X4:
            r0 = static_cast<float>(r0.f32 + r0.f32); code++; goto Next;
        case OpCode::AddF_R0_R1_X4:
            r0 = static_cast<float>(r0.f32 + r1.f32); code++; goto Next;
        case OpCode::AddF_R0_R2_X4:
            r0 = static_cast<float>(r0.f32 + r2.f32); code++; goto Next;
        case OpCode::AddF_R0_R3_X4:
            r0 = static_cast<float>(r0.f32 + r3.f32); code++; goto Next;
        case OpCode::AddF_R0_R4_X4:
            r0 = static_cast<float>(r0.f32 + r4.f32); code++; goto Next;
        case OpCode::AddF_R0_R5_X4:
            r0 = static_cast<float>(r0.f32 + r5.f32); code++; goto Next;
        case OpCode::AddF_R0_R6_X4:
            r0 = static_cast<float>(r0.f32 + r6.f32); code++; goto Next;
        case OpCode::AddF_R0_R7_X4:
            r0 = static_cast<float>(r0.f32 + r7.f32); code++; goto Next;
        case OpCode::AddF_R1_R0_X4:
            r1 = static_cast<float>(r1.f32 + r0.f32); code++; goto Next;
        case OpCode::AddF_R1_R1_X4:
            r1 = static_cast<float>(r1.f32 + r1.f32); code++; goto Next;
        case OpCode::AddF_R1_R2_X4:
            r1 = static_cast<float>(r1.f32 + r2.f32); code++; goto Next;
        case OpCode::AddF_R1_R3_X4:
            r1 = static_cast<float>(r1.f32 + r3.f32); code++; goto Next;
        case OpCode::AddF_R1_R4_X4:
            r1 = static_cast<float>(r1.f32 + r4.f32); code++; goto Next;
        case OpCode::AddF_R1_R5_X4:
            r1 = static_cast<float>(r1.f32 + r5.f32); code++; goto Next;
        case OpCode::AddF_R1_R6_X4:
            r1 = static_cast<float>(r1.f32 + r6.f32); code++; goto Next;
        case OpCode::AddF_R1_R7_X4:
            r1 = static_cast<float>(r1.f32 + r7.f32); code++; goto Next;
        case OpCode::AddF_R2_R0_X4:
            r2 = static_cast<float>(r2.f32 + r0.f32); code++; goto Next;
        case OpCode::AddF_R2_R1_X4:
            r2 = static_cast<float>(r2.f32 + r1.f32); code++; goto Next;
        case OpCode::AddF_R2_R2_X4:
            r2 = static_cast<float>(r2.f32 + r2.f32); code++; goto Next;
        case OpCode::AddF_R2_R3_X4:
            r2 = static_cast<float>(r2.f32 + r3.f32); code++; goto Next;
        case OpCode::AddF_R2_R4_X4:
            r2 = static_cast<float>(r2.f32 + r4.f32); code++; goto Next;
        case OpCode::AddF_R2_R5_X4:
            r2 = static_cast<float>(r2.f32 + r5.f32); code++; goto Next;
        case OpCode::AddF_R2_R6_X4:
            r2 = static_cast<float>(r2.f32 + r6.f32); code++; goto Next;
        case OpCode::AddF_R2_R7_X4:
            r2 = static_cast<float>(r2.f32 + r7.f32); code++; goto Next;
        case OpCode::AddF_R3_R0_X4:
            r3 = static_cast<float>(r3.f32 + r0.f32); code++; goto Next;
        case OpCode::AddF_R3_R1_X4:
            r3 = static_cast<float>(r3.f32 + r1.f32); code++; goto Next;
        case OpCode::AddF_R3_R2_X4:
            r3 = static_cast<float>(r3.f32 + r2.f32); code++; goto Next;
        case OpCode::AddF_R3_R3_X4:
            r3 = static_cast<float>(r3.f32 + r3.f32); code++; goto Next;
        case OpCode::AddF_R3_R4_X4:
            r3 = static_cast<float>(r3.f32 + r4.f32); code++; goto Next;
        case OpCode::AddF_R3_R5_X4:
            r3 = static_cast<float>(r3.f32 + r5.f32); code++; goto Next;
        case OpCode::AddF_R3_R6_X4:
            r3 = static_cast<float>(r3.f32 + r6.f32); code++; goto Next;
        case OpCode::AddF_R3_R7_X4:
            r3 = static_cast<float>(r3.f32 + r7.f32); code++; goto Next;
        case OpCode::AddF_R4_R0_X4:
            r4 = static_cast<float>(r4.f32 + r0.f32); code++; goto Next;
        case OpCode::AddF_R4_R1_X4:
            r4 = static_cast<float>(r4.f32 + r1.f32); code++; goto Next;
        case OpCode::AddF_R4_R2_X4:
            r4 = static_cast<float>(r4.f32 + r2.f32); code++; goto Next;
        case OpCode::AddF_R4_R3_X4:
            r4 = static_cast<float>(r4.f32 + r3.f32); code++; goto Next;
        case OpCode::AddF_R4_R4_X4:
            r4 = static_cast<float>(r4.f32 + r4.f32); code++; goto Next;
        case OpCode::AddF_R4_R5_X4:
            r4 = static_cast<float>(r4.f32 + r5.f32); code++; goto Next;
        case OpCode::AddF_R4_R6_X4:
            r4 = static_cast<float>(r4.f32 + r6.f32); code++; goto Next;
        case OpCode::AddF_R4_R7_X4:
            r4 = static_cast<float>(r4.f32 + r7.f32); code++; goto Next;
        case OpCode::AddF_R5_R0_X4:
            r5 = static_cast<float>(r5.f32 + r0.f32); code++; goto Next;
        case OpCode::AddF_R5_R1_X4:
            r5 = static_cast<float>(r5.f32 + r1.f32); code++; goto Next;
        case OpCode::AddF_R5_R2_X4:
            r5 = static_cast<float>(r5.f32 + r2.f32); code++; goto Next;
        case OpCode::AddF_R5_R3_X4:
            r5 = static_cast<float>(r5.f32 + r3.f32); code++; goto Next;
        case OpCode::AddF_R5_R4_X4:
            r5 = static_cast<float>(r5.f32 + r4.f32); code++; goto Next;
        case OpCode::AddF_R5_R5_X4:
            r5 = static_cast<float>(r5.f32 + r5.f32); code++; goto Next;
        case OpCode::AddF_R5_R6_X4:
            r5 = static_cast<float>(r5.f32 + r6.f32); code++; goto Next;
        case OpCode::AddF_R5_R7_X4:
            r5 = static_cast<float>(r5.f32 + r7.f32); code++; goto Next;
        case OpCode::AddF_R6_R0_X4:
            r6 = static_cast<float>(r6.f32 + r0.f32); code++; goto Next;
        case OpCode::AddF_R6_R1_X4:
            r6 = static_cast<float>(r6.f32 + r1.f32); code++; goto Next;
        case OpCode::AddF_R6_R2_X4:
            r6 = static_cast<float>(r6.f32 + r2.f32); code++; goto Next;
        case OpCode::AddF_R6_R3_X4:
            r6 = static_cast<float>(r6.f32 + r3.f32); code++; goto Next;
        case OpCode::AddF_R6_R4_X4:
            r6 = static_cast<float>(r6.f32 + r4.f32); code++; goto Next;
        case OpCode::AddF_R6_R5_X4:
            r6 = static_cast<float>(r6.f32 + r5.f32); code++; goto Next;
        case OpCode::AddF_R6_R6_X4:
            r6 = static_cast<float>(r6.f32 + r6.f32); code++; goto Next;
        case OpCode::AddF_R6_R7_X4:
            r6 = static_cast<float>(r6.f32 + r7.f32); code++; goto Next;
        case OpCode::AddF_R7_R0_X4:
            r7 = static_cast<float>(r7.f32 + r0.f32); code++; goto Next;
        case OpCode::AddF_R7_R1_X4:
            r7 = static_cast<float>(r7.f32 + r1.f32); code++; goto Next;
        case OpCode::AddF_R7_R2_X4:
            r7 = static_cast<float>(r7.f32 + r2.f32); code++; goto Next;
        case OpCode::AddF_R7_R3_X4:
            r7 = static_cast<float>(r7.f32 + r3.f32); code++; goto Next;
        case OpCode::AddF_R7_R4_X4:
            r7 = static_cast<float>(r7.f32 + r4.f32); code++; goto Next;
        case OpCode::AddF_R7_R5_X4:
            r7 = static_cast<float>(r7.f32 + r5.f32); code++; goto Next;
        case OpCode::AddF_R7_R6_X4:
            r7 = static_cast<float>(r7.f32 + r6.f32); code++; goto Next;
        case OpCode::AddF_R7_R7_X4:
            r7 = static_cast<float>(r7.f32 + r7.f32); code++; goto Next;
        ...
        case OpCode::AddF_R0_R0_X8:
            r0 = static_cast<double>(r0.f64 + r0.f64); code++; goto Next;
        case OpCode::AddF_R0_R1_X8:
            r0 = static_cast<double>(r0.f64 + r1.f64); code++; goto Next;
        case OpCode::AddF_R0_R2_X8:
            r0 = static_cast<double>(r0.f64 + r2.f64); code++; goto Next;
        case OpCode::AddF_R0_R3_X8:
            r0 = static_cast<double>(r0.f64 + r3.f64); code++; goto Next;
        case OpCode::AddF_R0_R4_X8:
            r0 = static_cast<double>(r0.f64 + r4.f64); code++; goto Next;
        case OpCode::AddF_R0_R5_X8:
            r0 = static_cast<double>(r0.f64 + r5.f64); code++; goto Next;
        case OpCode::AddF_R0_R6_X8:
            r0 = static_cast<double>(r0.f64 + r6.f64); code++; goto Next;
        case OpCode::AddF_R0_R7_X8:
            r0 = static_cast<double>(r0.f64 + r7.f64); code++; goto Next;
        case OpCode::AddF_R1_R0_X8:
            r1 = static_cast<double>(r1.f64 + r0.f64); code++; goto Next;
        case OpCode::AddF_R1_R1_X8:
            r1 = static_cast<double>(r1.f64 + r1.f64); code++; goto Next;
        case OpCode::AddF_R1_R2_X8:
            r1 = static_cast<double>(r1.f64 + r2.f64); code++; goto Next;
        case OpCode::AddF_R1_R3_X8:
            r1 = static_cast<double>(r1.f64 + r3.f64); code++; goto Next;
        case OpCode::AddF_R1_R4_X8:
            r1 = static_cast<double>(r1.f64 + r4.f64); code++; goto Next;
        case OpCode::AddF_R1_R5_X8:
            r1 = static_cast<double>(r1.f64 + r5.f64); code++; goto Next;
        case OpCode::AddF_R1_R6_X8:
            r1 = static_cast<double>(r1.f64 + r6.f64); code++; goto Next;
        case OpCode::AddF_R1_R7_X8:
            r1 = static_cast<double>(r1.f64 + r7.f64); code++; goto Next;
        case OpCode::AddF_R2_R0_X8:
            r2 = static_cast<double>(r2.f64 + r0.f64); code++; goto Next;
        case OpCode::AddF_R2_R1_X8:
            r2 = static_cast<double>(r2.f64 + r1.f64); code++; goto Next;
        case OpCode::AddF_R2_R2_X8:
            r2 = static_cast<double>(r2.f64 + r2.f64); code++; goto Next;
        case OpCode::AddF_R2_R3_X8:
            r2 = static_cast<double>(r2.f64 + r3.f64); code++; goto Next;
        case OpCode::AddF_R2_R4_X8:
            r2 = static_cast<double>(r2.f64 + r4.f64); code++; goto Next;
        case OpCode::AddF_R2_R5_X8:
            r2 = static_cast<double>(r2.f64 + r5.f64); code++; goto Next;
        case OpCode::AddF_R2_R6_X8:
            r2 = static_cast<double>(r2.f64 + r6.f64); code++; goto Next;
        case OpCode::AddF_R2_R7_X8:
            r2 = static_cast<double>(r2.f64 + r7.f64); code++; goto Next;
        case OpCode::AddF_R3_R0_X8:
            r3 = static_cast<double>(r3.f64 + r0.f64); code++; goto Next;
        case OpCode::AddF_R3_R1_X8:
            r3 = static_cast<double>(r3.f64 + r1.f64); code++; goto Next;
        case OpCode::AddF_R3_R2_X8:
            r3 = static_cast<double>(r3.f64 + r2.f64); code++; goto Next;
        case OpCode::AddF_R3_R3_X8:
            r3 = static_cast<double>(r3.f64 + r3.f64); code++; goto Next;
        case OpCode::AddF_R3_R4_X8:
            r3 = static_cast<double>(r3.f64 + r4.f64); code++; goto Next;
        case OpCode::AddF_R3_R5_X8:
            r3 = static_cast<double>(r3.f64 + r5.f64); code++; goto Next;
        case OpCode::AddF_R3_R6_X8:
            r3 = static_cast<double>(r3.f64 + r6.f64); code++; goto Next;
        case OpCode::AddF_R3_R7_X8:
            r3 = static_cast<double>(r3.f64 + r7.f64); code++; goto Next;
        case OpCode::AddF_R4_R0_X8:
            r4 = static_cast<double>(r4.f64 + r0.f64); code++; goto Next;
        case OpCode::AddF_R4_R1_X8:
            r4 = static_cast<double>(r4.f64 + r1.f64); code++; goto Next;
        case OpCode::AddF_R4_R2_X8:
            r4 = static_cast<double>(r4.f64 + r2.f64); code++; goto Next;
        case OpCode::AddF_R4_R3_X8:
            r4 = static_cast<double>(r4.f64 + r3.f64); code++; goto Next;
        case OpCode::AddF_R4_R4_X8:
            r4 = static_cast<double>(r4.f64 + r4.f64); code++; goto Next;
        case OpCode::AddF_R4_R5_X8:
            r4 = static_cast<double>(r4.f64 + r5.f64); code++; goto Next;
        case OpCode::AddF_R4_R6_X8:
            r4 = static_cast<double>(r4.f64 + r6.f64); code++; goto Next;
        case OpCode::AddF_R4_R7_X8:
            r4 = static_cast<double>(r4.f64 + r7.f64); code++; goto Next;
        case OpCode::AddF_R5_R0_X8:
            r5 = static_cast<double>(r5.f64 + r0.f64); code++; goto Next;
        case OpCode::AddF_R5_R1_X8:
            r5 = static_cast<double>(r5.f64 + r1.f64); code++; goto Next;
        case OpCode::AddF_R5_R2_X8:
            r5 = static_cast<double>(r5.f64 + r2.f64); code++; goto Next;
        case OpCode::AddF_R5_R3_X8:
            r5 = static_cast<double>(r5.f64 + r3.f64); code++; goto Next;
        case OpCode::AddF_R5_R4_X8:
            r5 = static_cast<double>(r5.f64 + r4.f64); code++; goto Next;
        case OpCode::AddF_R5_R5_X8:
            r5 = static_cast<double>(r5.f64 + r5.f64); code++; goto Next;
        case OpCode::AddF_R5_R6_X8:
            r5 = static_cast<double>(r5.f64 + r6.f64); code++; goto Next;
        case OpCode::AddF_R5_R7_X8:
            r5 = static_cast<double>(r5.f64 + r7.f64); code++; goto Next;
        case OpCode::AddF_R6_R0_X8:
            r6 = static_cast<double>(r6.f64 + r0.f64); code++; goto Next;
        case OpCode::AddF_R6_R1_X8:
            r6 = static_cast<double>(r6.f64 + r1.f64); code++; goto Next;
        case OpCode::AddF_R6_R2_X8:
            r6 = static_cast<double>(r6.f64 + r2.f64); code++; goto Next;
        case OpCode::AddF_R6_R3_X8:
            r6 = static_cast<double>(r6.f64 + r3.f64); code++; goto Next;
        case OpCode::AddF_R6_R4_X8:
            r6 = static_cast<double>(r6.f64 + r4.f64); code++; goto Next;
        case OpCode::AddF_R6_R5_X8:
            r6 = static_cast<double>(r6.f64 + r5.f64); code++; goto Next;
        case OpCode::AddF_R6_R6_X8:
            r6 = static_cast<double>(r6.f64 + r6.f64); code++; goto Next;
        case OpCode::AddF_R6_R7_X8:
            r6 = static_cast<double>(r6.f64 + r7.f64); code++; goto Next;
        case OpCode::AddF_R7_R0_X8:
            r7 = static_cast<double>(r7.f64 + r0.f64); code++; goto Next;
        case OpCode::AddF_R7_R1_X8:
            r7 = static_cast<double>(r7.f64 + r1.f64); code++; goto Next;
        case OpCode::AddF_R7_R2_X8:
            r7 = static_cast<double>(r7.f64 + r2.f64); code++; goto Next;
        case OpCode::AddF_R7_R3_X8:
            r7 = static_cast<double>(r7.f64 + r3.f64); code++; goto Next;
        case OpCode::AddF_R7_R4_X8:
            r7 = static_cast<double>(r7.f64 + r4.f64); code++; goto Next;
        case OpCode::AddF_R7_R5_X8:
            r7 = static_cast<double>(r7.f64 + r5.f64); code++; goto Next;
        case OpCode::AddF_R7_R6_X8:
            r7 = static_cast<double>(r7.f64 + r6.f64); code++; goto Next;
        case OpCode::AddF_R7_R7_X8:
            r7 = static_cast<double>(r7.f64 + r7.f64); code++; goto Next;
        ...
        case OpCode::BTrue_R0: // <op> <u2 op offset>
            code += r0.u64 == 0 ? 2 : *(code + 1); goto Next;
        case OpCode::BTrue_R1: // <op> <u2 op offset>
            code += r1.u64 == 0 ? 2 : *(code + 1); goto Next;
        case OpCode::BTrue_R2: // <op> <u2 op offset>
            code += r2.u64 == 0 ? 2 : *(code + 1); goto Next;
        case OpCode::BTrue_R3: // <op> <u2 op offset>
            code += r3.u64 == 0 ? 2 : *(code + 1); goto Next;
        case OpCode::BTrue_R4: // <op> <u2 op offset>
            code += r4.u64 == 0 ? 2 : *(code + 1); goto Next;
        case OpCode::BTrue_R5: // <op> <u2 op offset>
            code += r5.u64 == 0 ? 2 : *(code + 1); goto Next;
        case OpCode::BTrue_R6: // <op> <u2 op offset>
            code += r6.u64 == 0 ? 2 : *(code + 1); goto Next;
        case OpCode::BTrue_R7: // <op> <u2 op offset>
            code += r7.u64 == 0 ? 2 : *(code + 1); goto Next;
